...
#  zukgit
# gainianguliebiao_zukgit_website  =   https://tushare.pro/document/2?doc_id=126
createexcel('概念股列表.xlsx')
concept_detail_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\概念股列表.xlsx')
concept_detail_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\概念股列表.xlsx', engine='openpyxl')
concept_detail_excel_writer.book = concept_detail_book
concept_detail_excel_writer.sheets = dict((ws.title, ws) for ws in concept_detail_book.worksheets)
concept_detail_data_List = pd.DataFrame()
concept_detail_item_0 = pro.concept_detail(id='TS2', fields='id,concept_name,ts_code,name,in_date,out_date')
print(" 概念股列表 concept_detail_item_0 返回数据 row 行数 = "+str(concept_detail_item_0.shape[0]))
concept_detail_data_List = concept_detail_data_List.append(concept_detail_item_0)


print("concept_detail_data_List.__len__() = "+str(concept_detail_data_List.__len__()))
concept_detail_data_List.to_excel(concept_detail_excel_writer,'概念股列表',index=False)
concept_detail_excel_writer.save()
