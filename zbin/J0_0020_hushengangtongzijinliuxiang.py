...
#  zukgit
# hushengangtongzijinliuxiang_zukgit_website  =   https://tushare.pro/document/2?doc_id=47
createexcel('沪深港通资金流向.xlsx')
moneyflow_hsgt_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\沪深港通资金流向.xlsx')
moneyflow_hsgt_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\沪深港通资金流向.xlsx', engine='openpyxl')
moneyflow_hsgt_excel_writer.book = moneyflow_hsgt_book
moneyflow_hsgt_excel_writer.sheets = dict((ws.title, ws) for ws in moneyflow_hsgt_book.worksheets)
moneyflow_hsgt_data_List = pd.DataFrame()
moneyflow_hsgt_item_0 = pro.moneyflow_hsgt(start_date='20210101',end_date='20211130', fields='trade_date,ggt_ss,ggt_sz,hgt,sgt,north_money,south_money')
print(" 沪深港通资金流向 moneyflow_hsgt_item_0 返回数据 row 行数 = "+str(moneyflow_hsgt_item_0.shape[0]))
moneyflow_hsgt_data_List = moneyflow_hsgt_data_List.append(moneyflow_hsgt_item_0)


print("moneyflow_hsgt_data_List.__len__() = "+str(moneyflow_hsgt_data_List.__len__()))
moneyflow_hsgt_data_List.to_excel(moneyflow_hsgt_excel_writer,'沪深港通资金流向',index=False)
moneyflow_hsgt_excel_writer.save()
