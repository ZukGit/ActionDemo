...
trade_cal_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\交易日历.xlsx')
trade_cal_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\交易日历.xlsx', engine='openpyxl')
...
print(" 交易日历 trade_cal_item_0 返回数据 row 行数 = "+str(trade_cal_item_0.shape[0]))
...
print(" 交易日历 trade_cal_item_1 返回数据 row 行数 = "+str(trade_cal_item_1.shape[0]))
...
print(" 交易日历 trade_cal_item_2 返回数据 row 行数 = "+str(trade_cal_item_2.shape[0]))
...
print(" 交易日历 trade_cal_item_3 返回数据 row 行数 = "+str(trade_cal_item_3.shape[0]))
...
print(" 交易日历 trade_cal_item_4 返回数据 row 行数 = "+str(trade_cal_item_4.shape[0]))
...
print(" 交易日历 trade_cal_item_5 返回数据 row 行数 = "+str(trade_cal_item_5.shape[0]))
...
print(" 交易日历 trade_cal_item_6 返回数据 row 行数 = "+str(trade_cal_item_6.shape[0]))
...
print(" 交易日历 trade_cal_item_7 返回数据 row 行数 = "+str(trade_cal_item_7.shape[0]))
...
print(" 交易日历 trade_cal_item_8 返回数据 row 行数 = "+str(trade_cal_item_8.shape[0]))
