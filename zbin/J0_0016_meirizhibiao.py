...
#  zukgit
# meirizhibiao_zukgit_website  =   https://tushare.pro/document/2?doc_id=32
tree_node_name="meirizhibiao"+"_"
createexcel('daily_basic_202112.xlsx')
daily_basic_202112_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\daily_basic_202112.xlsx')
daily_basic_202112_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\daily_basic_202112.xlsx', engine='openpyxl')
daily_basic_202112_excel_writer.book = daily_basic_202112_book
daily_basic_202112_excel_writer.sheets = dict((ws.title, ws) for ws in daily_basic_202112_book.worksheets)
J0_PROPS.put(tree_node_name+"record_date", "20211201")       ###  更新 记录日期




createexcel('daily_basic_202201.xlsx')
daily_basic_202201_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\daily_basic_202201.xlsx')
daily_basic_202201_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\daily_basic_202201.xlsx', engine='openpyxl')
daily_basic_202201_excel_writer.book = daily_basic_202201_book
daily_basic_202201_excel_writer.sheets = dict((ws.title, ws) for ws in daily_basic_202201_book.worksheets)
J0_PROPS.put(tree_node_name+"record_date", "20220101")       ###  更新 记录日期
