...
#  zukgit
# geguzijinliuxiang_zukgit_website  =   https://tushare.pro/document/2?doc_id=170
tree_node_name="geguzijinliuxiang"+"_"
createexcel('moneyflow_203001.xlsx')
moneyflow_203001_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\moneyflow_203001.xlsx')
moneyflow_203001_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\moneyflow_203001.xlsx', engine='openpyxl')
moneyflow_203001_excel_writer.book = moneyflow_203001_book
moneyflow_203001_excel_writer.sheets = dict((ws.title, ws) for ws in moneyflow_203001_book.worksheets)
J0_PROPS.put(tree_node_name+"record_date", "20300101")       ###  更新 记录日期




createexcel('moneyflow_203002.xlsx')
moneyflow_203002_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\moneyflow_203002.xlsx')
moneyflow_203002_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\moneyflow_203002.xlsx', engine='openpyxl')
moneyflow_203002_excel_writer.book = moneyflow_203002_book
moneyflow_203002_excel_writer.sheets = dict((ws.title, ws) for ws in moneyflow_203002_book.worksheets)
J0_PROPS.put(tree_node_name+"record_date", "20300201")       ###  更新 记录日期
