...
stock_company_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\上市公司基本信息.xlsx')
stock_company_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\上市公司基本信息.xlsx', engine='openpyxl')
...
print("上市公司基本信息  stock_company_item_0 返回数据 row 行数 = "+str(stock_company_item_0.shape[0]))
...
print("上市公司基本信息  stock_company_item_1 返回数据 row 行数 = "+str(stock_company_item_1.shape[0]))
