...
stk_rewards_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\管理层薪酬和持股.xlsx')
stk_rewards_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\管理层薪酬和持股.xlsx', engine='openpyxl')
...
print("管理层薪酬和持股   stk_rewards_item_0 返回数据 row 行数 = "+str(stk_rewards_item_0.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
...
print("管理层薪酬和持股   stk_rewards_item_1 返回数据 row 行数 = "+str(stk_rewards_item_1.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_2 返回数据 row 行数 = "+str(stk_rewards_item_2.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_3 返回数据 row 行数 = "+str(stk_rewards_item_3.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_4 返回数据 row 行数 = "+str(stk_rewards_item_4.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_5 返回数据 row 行数 = "+str(stk_rewards_item_5.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_6 返回数据 row 行数 = "+str(stk_rewards_item_6.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_7 返回数据 row 行数 = "+str(stk_rewards_item_7.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_8 返回数据 row 行数 = "+str(stk_rewards_item_8.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_9 返回数据 row 行数 = "+str(stk_rewards_item_9.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_10 返回数据 row 行数 = "+str(stk_rewards_item_10.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_11 返回数据 row 行数 = "+str(stk_rewards_item_11.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_12 返回数据 row 行数 = "+str(stk_rewards_item_12.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_13 返回数据 row 行数 = "+str(stk_rewards_item_13.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_14 返回数据 row 行数 = "+str(stk_rewards_item_14.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_15 返回数据 row 行数 = "+str(stk_rewards_item_15.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_16 返回数据 row 行数 = "+str(stk_rewards_item_16.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_17 返回数据 row 行数 = "+str(stk_rewards_item_17.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_18 返回数据 row 行数 = "+str(stk_rewards_item_18.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_19 返回数据 row 行数 = "+str(stk_rewards_item_19.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_20 返回数据 row 行数 = "+str(stk_rewards_item_20.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_21 返回数据 row 行数 = "+str(stk_rewards_item_21.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_22 返回数据 row 行数 = "+str(stk_rewards_item_22.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_23 返回数据 row 行数 = "+str(stk_rewards_item_23.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_24 返回数据 row 行数 = "+str(stk_rewards_item_24.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_25 返回数据 row 行数 = "+str(stk_rewards_item_25.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_26 返回数据 row 行数 = "+str(stk_rewards_item_26.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_27 返回数据 row 行数 = "+str(stk_rewards_item_27.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_28 返回数据 row 行数 = "+str(stk_rewards_item_28.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_29 返回数据 row 行数 = "+str(stk_rewards_item_29.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_30 返回数据 row 行数 = "+str(stk_rewards_item_30.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_31 返回数据 row 行数 = "+str(stk_rewards_item_31.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_32 返回数据 row 行数 = "+str(stk_rewards_item_32.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_33 返回数据 row 行数 = "+str(stk_rewards_item_33.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_34 返回数据 row 行数 = "+str(stk_rewards_item_34.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_35 返回数据 row 行数 = "+str(stk_rewards_item_35.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_36 返回数据 row 行数 = "+str(stk_rewards_item_36.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_37 返回数据 row 行数 = "+str(stk_rewards_item_37.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_38 返回数据 row 行数 = "+str(stk_rewards_item_38.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_39 返回数据 row 行数 = "+str(stk_rewards_item_39.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_40 返回数据 row 行数 = "+str(stk_rewards_item_40.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_41 返回数据 row 行数 = "+str(stk_rewards_item_41.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_42 返回数据 row 行数 = "+str(stk_rewards_item_42.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_43 返回数据 row 行数 = "+str(stk_rewards_item_43.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_44 返回数据 row 行数 = "+str(stk_rewards_item_44.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_45 返回数据 row 行数 = "+str(stk_rewards_item_45.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_46 返回数据 row 行数 = "+str(stk_rewards_item_46.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_47 返回数据 row 行数 = "+str(stk_rewards_item_47.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_48 返回数据 row 行数 = "+str(stk_rewards_item_48.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_49 返回数据 row 行数 = "+str(stk_rewards_item_49.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_50 返回数据 row 行数 = "+str(stk_rewards_item_50.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_51 返回数据 row 行数 = "+str(stk_rewards_item_51.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_52 返回数据 row 行数 = "+str(stk_rewards_item_52.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_53 返回数据 row 行数 = "+str(stk_rewards_item_53.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_54 返回数据 row 行数 = "+str(stk_rewards_item_54.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_55 返回数据 row 行数 = "+str(stk_rewards_item_55.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_56 返回数据 row 行数 = "+str(stk_rewards_item_56.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_57 返回数据 row 行数 = "+str(stk_rewards_item_57.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_58 返回数据 row 行数 = "+str(stk_rewards_item_58.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_59 返回数据 row 行数 = "+str(stk_rewards_item_59.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_60 返回数据 row 行数 = "+str(stk_rewards_item_60.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_61 返回数据 row 行数 = "+str(stk_rewards_item_61.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_62 返回数据 row 行数 = "+str(stk_rewards_item_62.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_63 返回数据 row 行数 = "+str(stk_rewards_item_63.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_64 返回数据 row 行数 = "+str(stk_rewards_item_64.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_65 返回数据 row 行数 = "+str(stk_rewards_item_65.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_66 返回数据 row 行数 = "+str(stk_rewards_item_66.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_67 返回数据 row 行数 = "+str(stk_rewards_item_67.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_68 返回数据 row 行数 = "+str(stk_rewards_item_68.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_69 返回数据 row 行数 = "+str(stk_rewards_item_69.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_70 返回数据 row 行数 = "+str(stk_rewards_item_70.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_71 返回数据 row 行数 = "+str(stk_rewards_item_71.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_72 返回数据 row 行数 = "+str(stk_rewards_item_72.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_73 返回数据 row 行数 = "+str(stk_rewards_item_73.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_74 返回数据 row 行数 = "+str(stk_rewards_item_74.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_75 返回数据 row 行数 = "+str(stk_rewards_item_75.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_76 返回数据 row 行数 = "+str(stk_rewards_item_76.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_77 返回数据 row 行数 = "+str(stk_rewards_item_77.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_78 返回数据 row 行数 = "+str(stk_rewards_item_78.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_79 返回数据 row 行数 = "+str(stk_rewards_item_79.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_80 返回数据 row 行数 = "+str(stk_rewards_item_80.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_81 返回数据 row 行数 = "+str(stk_rewards_item_81.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_82 返回数据 row 行数 = "+str(stk_rewards_item_82.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
print("管理层薪酬和持股   stk_rewards_item_83 返回数据 row 行数 = "+str(stk_rewards_item_83.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_84 = pro.stk_rewards(ts_code='000999.SZ,001201.SZ,001202.SZ,001203.SZ,001205.SZ,001206.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_84 返回数据 row 行数 = "+str(stk_rewards_item_84.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_85 = pro.stk_rewards(ts_code='001207.SZ,001208.SZ,001696.SZ,001872.SZ,001896.SZ,001914.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_85 返回数据 row 行数 = "+str(stk_rewards_item_85.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_86 = pro.stk_rewards(ts_code='001965.SZ,001979.SZ,002001.SZ,002002.SZ,002003.SZ,002004.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_86 返回数据 row 行数 = "+str(stk_rewards_item_86.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_87 = pro.stk_rewards(ts_code='002005.SZ,002006.SZ,002007.SZ,002008.SZ,002009.SZ,002010.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_87 返回数据 row 行数 = "+str(stk_rewards_item_87.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_88 = pro.stk_rewards(ts_code='002011.SZ,002012.SZ,002013.SZ,002014.SZ,002015.SZ,002016.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_88 返回数据 row 行数 = "+str(stk_rewards_item_88.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_89 = pro.stk_rewards(ts_code='002017.SZ,002018.SZ,002019.SZ,002020.SZ,002021.SZ,002022.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_89 返回数据 row 行数 = "+str(stk_rewards_item_89.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_90 = pro.stk_rewards(ts_code='002023.SZ,002024.SZ,002025.SZ,002026.SZ,002027.SZ,002028.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_90 返回数据 row 行数 = "+str(stk_rewards_item_90.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_91 = pro.stk_rewards(ts_code='002029.SZ,002030.SZ,002031.SZ,002032.SZ,002033.SZ,002034.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_91 返回数据 row 行数 = "+str(stk_rewards_item_91.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_92 = pro.stk_rewards(ts_code='002035.SZ,002036.SZ,002037.SZ,002038.SZ,002039.SZ,002040.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_92 返回数据 row 行数 = "+str(stk_rewards_item_92.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_93 = pro.stk_rewards(ts_code='002041.SZ,002042.SZ,002043.SZ,002044.SZ,002045.SZ,002046.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_93 返回数据 row 行数 = "+str(stk_rewards_item_93.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_94 = pro.stk_rewards(ts_code='002047.SZ,002048.SZ,002049.SZ,002050.SZ,002051.SZ,002052.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_94 返回数据 row 行数 = "+str(stk_rewards_item_94.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_95 = pro.stk_rewards(ts_code='002053.SZ,002054.SZ,002055.SZ,002056.SZ,002057.SZ,002058.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_95 返回数据 row 行数 = "+str(stk_rewards_item_95.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_96 = pro.stk_rewards(ts_code='002059.SZ,002060.SZ,002061.SZ,002062.SZ,002063.SZ,002064.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_96 返回数据 row 行数 = "+str(stk_rewards_item_96.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_97 = pro.stk_rewards(ts_code='002065.SZ,002066.SZ,002067.SZ,002068.SZ,002069.SZ,002070.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_97 返回数据 row 行数 = "+str(stk_rewards_item_97.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_98 = pro.stk_rewards(ts_code='002071.SZ,002072.SZ,002073.SZ,002074.SZ,002075.SZ,002076.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_98 返回数据 row 行数 = "+str(stk_rewards_item_98.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_99 = pro.stk_rewards(ts_code='002077.SZ,002078.SZ,002079.SZ,002080.SZ,002081.SZ,002082.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_99 返回数据 row 行数 = "+str(stk_rewards_item_99.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_100 = pro.stk_rewards(ts_code='002083.SZ,002084.SZ,002085.SZ,002086.SZ,002087.SZ,002088.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_100 返回数据 row 行数 = "+str(stk_rewards_item_100.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_101 = pro.stk_rewards(ts_code='002089.SZ,002090.SZ,002091.SZ,002092.SZ,002093.SZ,002094.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_101 返回数据 row 行数 = "+str(stk_rewards_item_101.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_102 = pro.stk_rewards(ts_code='002095.SZ,002096.SZ,002097.SZ,002098.SZ,002099.SZ,002100.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_102 返回数据 row 行数 = "+str(stk_rewards_item_102.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_103 = pro.stk_rewards(ts_code='002101.SZ,002102.SZ,002103.SZ,002104.SZ,002105.SZ,002106.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_103 返回数据 row 行数 = "+str(stk_rewards_item_103.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_104 = pro.stk_rewards(ts_code='002107.SZ,002108.SZ,002109.SZ,002110.SZ,002111.SZ,002112.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_104 返回数据 row 行数 = "+str(stk_rewards_item_104.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_105 = pro.stk_rewards(ts_code='002113.SZ,002114.SZ,002115.SZ,002116.SZ,002117.SZ,002118.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_105 返回数据 row 行数 = "+str(stk_rewards_item_105.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_106 = pro.stk_rewards(ts_code='002119.SZ,002120.SZ,002121.SZ,002122.SZ,002123.SZ,002124.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_106 返回数据 row 行数 = "+str(stk_rewards_item_106.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_107 = pro.stk_rewards(ts_code='002125.SZ,002126.SZ,002127.SZ,002128.SZ,002129.SZ,002130.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_107 返回数据 row 行数 = "+str(stk_rewards_item_107.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_108 = pro.stk_rewards(ts_code='002131.SZ,002132.SZ,002133.SZ,002134.SZ,002135.SZ,002136.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_108 返回数据 row 行数 = "+str(stk_rewards_item_108.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_109 = pro.stk_rewards(ts_code='002137.SZ,002138.SZ,002139.SZ,002140.SZ,002141.SZ,002142.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_109 返回数据 row 行数 = "+str(stk_rewards_item_109.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_110 = pro.stk_rewards(ts_code='002143.SZ,002144.SZ,002145.SZ,002146.SZ,002147.SZ,002148.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_110 返回数据 row 行数 = "+str(stk_rewards_item_110.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_111 = pro.stk_rewards(ts_code='002149.SZ,002150.SZ,002151.SZ,002152.SZ,002153.SZ,002154.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_111 返回数据 row 行数 = "+str(stk_rewards_item_111.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_112 = pro.stk_rewards(ts_code='002155.SZ,002156.SZ,002157.SZ,002158.SZ,002159.SZ,002160.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_112 返回数据 row 行数 = "+str(stk_rewards_item_112.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_113 = pro.stk_rewards(ts_code='002161.SZ,002162.SZ,002163.SZ,002164.SZ,002165.SZ,002166.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_113 返回数据 row 行数 = "+str(stk_rewards_item_113.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_114 = pro.stk_rewards(ts_code='002167.SZ,002168.SZ,002169.SZ,002170.SZ,002171.SZ,002172.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_114 返回数据 row 行数 = "+str(stk_rewards_item_114.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_115 = pro.stk_rewards(ts_code='002173.SZ,002174.SZ,002175.SZ,002176.SZ,002177.SZ,002178.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_115 返回数据 row 行数 = "+str(stk_rewards_item_115.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_116 = pro.stk_rewards(ts_code='002179.SZ,002180.SZ,002181.SZ,002182.SZ,002183.SZ,002184.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_116 返回数据 row 行数 = "+str(stk_rewards_item_116.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_117 = pro.stk_rewards(ts_code='002185.SZ,002186.SZ,002187.SZ,002188.SZ,002189.SZ,002190.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_117 返回数据 row 行数 = "+str(stk_rewards_item_117.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_118 = pro.stk_rewards(ts_code='002191.SZ,002192.SZ,002193.SZ,002194.SZ,002195.SZ,002196.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_118 返回数据 row 行数 = "+str(stk_rewards_item_118.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_119 = pro.stk_rewards(ts_code='002197.SZ,002198.SZ,002199.SZ,002200.SZ,002201.SZ,002202.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_119 返回数据 row 行数 = "+str(stk_rewards_item_119.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_120 = pro.stk_rewards(ts_code='002203.SZ,002204.SZ,002205.SZ,002206.SZ,002207.SZ,002208.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_120 返回数据 row 行数 = "+str(stk_rewards_item_120.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_121 = pro.stk_rewards(ts_code='002209.SZ,002210.SZ,002211.SZ,002212.SZ,002213.SZ,002214.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_121 返回数据 row 行数 = "+str(stk_rewards_item_121.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_122 = pro.stk_rewards(ts_code='002215.SZ,002216.SZ,002217.SZ,002218.SZ,002219.SZ,002220.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_122 返回数据 row 行数 = "+str(stk_rewards_item_122.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_123 = pro.stk_rewards(ts_code='002221.SZ,002222.SZ,002223.SZ,002224.SZ,002225.SZ,002226.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_123 返回数据 row 行数 = "+str(stk_rewards_item_123.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_124 = pro.stk_rewards(ts_code='002227.SZ,002228.SZ,002229.SZ,002230.SZ,002231.SZ,002232.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_124 返回数据 row 行数 = "+str(stk_rewards_item_124.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_125 = pro.stk_rewards(ts_code='002233.SZ,002234.SZ,002235.SZ,002236.SZ,002237.SZ,002238.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_125 返回数据 row 行数 = "+str(stk_rewards_item_125.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_126 = pro.stk_rewards(ts_code='002239.SZ,002240.SZ,002241.SZ,002242.SZ,002243.SZ,002244.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_126 返回数据 row 行数 = "+str(stk_rewards_item_126.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_127 = pro.stk_rewards(ts_code='002245.SZ,002246.SZ,002247.SZ,002248.SZ,002249.SZ,002250.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_127 返回数据 row 行数 = "+str(stk_rewards_item_127.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_128 = pro.stk_rewards(ts_code='002251.SZ,002252.SZ,002253.SZ,002254.SZ,002255.SZ,002256.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_128 返回数据 row 行数 = "+str(stk_rewards_item_128.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_129 = pro.stk_rewards(ts_code='002258.SZ,002259.SZ,002260.SZ,002261.SZ,002262.SZ,002263.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_129 返回数据 row 行数 = "+str(stk_rewards_item_129.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_130 = pro.stk_rewards(ts_code='002264.SZ,002265.SZ,002266.SZ,002267.SZ,002268.SZ,002269.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_130 返回数据 row 行数 = "+str(stk_rewards_item_130.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_131 = pro.stk_rewards(ts_code='002270.SZ,002271.SZ,002272.SZ,002273.SZ,002274.SZ,002275.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_131 返回数据 row 行数 = "+str(stk_rewards_item_131.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_132 = pro.stk_rewards(ts_code='002276.SZ,002277.SZ,002278.SZ,002279.SZ,002280.SZ,002281.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_132 返回数据 row 行数 = "+str(stk_rewards_item_132.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_133 = pro.stk_rewards(ts_code='002282.SZ,002283.SZ,002284.SZ,002285.SZ,002286.SZ,002287.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_133 返回数据 row 行数 = "+str(stk_rewards_item_133.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_134 = pro.stk_rewards(ts_code='002288.SZ,002289.SZ,002290.SZ,002291.SZ,002292.SZ,002293.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_134 返回数据 row 行数 = "+str(stk_rewards_item_134.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_135 = pro.stk_rewards(ts_code='002294.SZ,002295.SZ,002296.SZ,002297.SZ,002298.SZ,002299.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_135 返回数据 row 行数 = "+str(stk_rewards_item_135.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_136 = pro.stk_rewards(ts_code='002300.SZ,002301.SZ,002302.SZ,002303.SZ,002304.SZ,002305.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_136 返回数据 row 行数 = "+str(stk_rewards_item_136.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_137 = pro.stk_rewards(ts_code='002306.SZ,002307.SZ,002308.SZ,002309.SZ,002310.SZ,002311.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_137 返回数据 row 行数 = "+str(stk_rewards_item_137.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_138 = pro.stk_rewards(ts_code='002312.SZ,002313.SZ,002314.SZ,002315.SZ,002316.SZ,002317.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_138 返回数据 row 行数 = "+str(stk_rewards_item_138.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_139 = pro.stk_rewards(ts_code='002318.SZ,002319.SZ,002320.SZ,002321.SZ,002322.SZ,002323.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_139 返回数据 row 行数 = "+str(stk_rewards_item_139.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_140 = pro.stk_rewards(ts_code='002324.SZ,002325.SZ,002326.SZ,002327.SZ,002328.SZ,002329.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_140 返回数据 row 行数 = "+str(stk_rewards_item_140.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_141 = pro.stk_rewards(ts_code='002330.SZ,002331.SZ,002332.SZ,002333.SZ,002334.SZ,002335.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_141 返回数据 row 行数 = "+str(stk_rewards_item_141.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_142 = pro.stk_rewards(ts_code='002336.SZ,002337.SZ,002338.SZ,002339.SZ,002340.SZ,002341.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_142 返回数据 row 行数 = "+str(stk_rewards_item_142.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_143 = pro.stk_rewards(ts_code='002342.SZ,002343.SZ,002344.SZ,002345.SZ,002346.SZ,002347.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_143 返回数据 row 行数 = "+str(stk_rewards_item_143.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_144 = pro.stk_rewards(ts_code='002348.SZ,002349.SZ,002350.SZ,002351.SZ,002352.SZ,002353.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_144 返回数据 row 行数 = "+str(stk_rewards_item_144.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_145 = pro.stk_rewards(ts_code='002354.SZ,002355.SZ,002356.SZ,002357.SZ,002358.SZ,002359.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_145 返回数据 row 行数 = "+str(stk_rewards_item_145.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_146 = pro.stk_rewards(ts_code='002360.SZ,002361.SZ,002362.SZ,002363.SZ,002364.SZ,002365.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_146 返回数据 row 行数 = "+str(stk_rewards_item_146.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_147 = pro.stk_rewards(ts_code='002366.SZ,002367.SZ,002368.SZ,002369.SZ,002370.SZ,002371.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_147 返回数据 row 行数 = "+str(stk_rewards_item_147.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_148 = pro.stk_rewards(ts_code='002372.SZ,002373.SZ,002374.SZ,002375.SZ,002376.SZ,002377.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_148 返回数据 row 行数 = "+str(stk_rewards_item_148.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_149 = pro.stk_rewards(ts_code='002378.SZ,002379.SZ,002380.SZ,002381.SZ,002382.SZ,002383.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_149 返回数据 row 行数 = "+str(stk_rewards_item_149.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_150 = pro.stk_rewards(ts_code='002384.SZ,002385.SZ,002386.SZ,002387.SZ,002388.SZ,002389.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_150 返回数据 row 行数 = "+str(stk_rewards_item_150.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_151 = pro.stk_rewards(ts_code='002390.SZ,002391.SZ,002392.SZ,002393.SZ,002394.SZ,002395.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_151 返回数据 row 行数 = "+str(stk_rewards_item_151.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_152 = pro.stk_rewards(ts_code='002396.SZ,002397.SZ,002398.SZ,002399.SZ,002400.SZ,002401.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_152 返回数据 row 行数 = "+str(stk_rewards_item_152.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_153 = pro.stk_rewards(ts_code='002402.SZ,002403.SZ,002404.SZ,002405.SZ,002406.SZ,002407.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_153 返回数据 row 行数 = "+str(stk_rewards_item_153.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_154 = pro.stk_rewards(ts_code='002408.SZ,002409.SZ,002410.SZ,002411.SZ,002412.SZ,002413.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_154 返回数据 row 行数 = "+str(stk_rewards_item_154.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_155 = pro.stk_rewards(ts_code='002414.SZ,002415.SZ,002416.SZ,002417.SZ,002418.SZ,002419.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_155 返回数据 row 行数 = "+str(stk_rewards_item_155.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_156 = pro.stk_rewards(ts_code='002420.SZ,002421.SZ,002422.SZ,002423.SZ,002424.SZ,002425.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_156 返回数据 row 行数 = "+str(stk_rewards_item_156.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_157 = pro.stk_rewards(ts_code='002426.SZ,002427.SZ,002428.SZ,002429.SZ,002430.SZ,002431.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_157 返回数据 row 行数 = "+str(stk_rewards_item_157.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_158 = pro.stk_rewards(ts_code='002432.SZ,002433.SZ,002434.SZ,002435.SZ,002436.SZ,002437.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_158 返回数据 row 行数 = "+str(stk_rewards_item_158.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_159 = pro.stk_rewards(ts_code='002438.SZ,002439.SZ,002440.SZ,002441.SZ,002442.SZ,002443.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_159 返回数据 row 行数 = "+str(stk_rewards_item_159.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_160 = pro.stk_rewards(ts_code='002444.SZ,002445.SZ,002446.SZ,002447.SZ,002448.SZ,002449.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_160 返回数据 row 行数 = "+str(stk_rewards_item_160.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_161 = pro.stk_rewards(ts_code='002450.SZ,002451.SZ,002452.SZ,002453.SZ,002454.SZ,002455.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_161 返回数据 row 行数 = "+str(stk_rewards_item_161.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_162 = pro.stk_rewards(ts_code='002456.SZ,002457.SZ,002458.SZ,002459.SZ,002460.SZ,002461.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_162 返回数据 row 行数 = "+str(stk_rewards_item_162.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_163 = pro.stk_rewards(ts_code='002462.SZ,002463.SZ,002464.SZ,002465.SZ,002466.SZ,002467.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_163 返回数据 row 行数 = "+str(stk_rewards_item_163.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_164 = pro.stk_rewards(ts_code='002468.SZ,002469.SZ,002470.SZ,002471.SZ,002472.SZ,002473.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_164 返回数据 row 行数 = "+str(stk_rewards_item_164.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_165 = pro.stk_rewards(ts_code='002474.SZ,002475.SZ,002476.SZ,002477.SZ,002478.SZ,002479.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_165 返回数据 row 行数 = "+str(stk_rewards_item_165.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_166 = pro.stk_rewards(ts_code='002480.SZ,002481.SZ,002482.SZ,002483.SZ,002484.SZ,002485.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_166 返回数据 row 行数 = "+str(stk_rewards_item_166.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_167 = pro.stk_rewards(ts_code='002486.SZ,002487.SZ,002488.SZ,002489.SZ,002490.SZ,002491.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_167 返回数据 row 行数 = "+str(stk_rewards_item_167.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_168 = pro.stk_rewards(ts_code='002492.SZ,002493.SZ,002494.SZ,002495.SZ,002496.SZ,002497.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_168 返回数据 row 行数 = "+str(stk_rewards_item_168.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_169 = pro.stk_rewards(ts_code='002498.SZ,002499.SZ,002500.SZ,002501.SZ,002502.SZ,002503.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_169 返回数据 row 行数 = "+str(stk_rewards_item_169.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_170 = pro.stk_rewards(ts_code='002504.SZ,002505.SZ,002506.SZ,002507.SZ,002508.SZ,002509.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_170 返回数据 row 行数 = "+str(stk_rewards_item_170.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_171 = pro.stk_rewards(ts_code='002510.SZ,002511.SZ,002512.SZ,002513.SZ,002514.SZ,002515.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_171 返回数据 row 行数 = "+str(stk_rewards_item_171.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_172 = pro.stk_rewards(ts_code='002516.SZ,002517.SZ,002518.SZ,002519.SZ,002520.SZ,002521.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_172 返回数据 row 行数 = "+str(stk_rewards_item_172.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_173 = pro.stk_rewards(ts_code='002522.SZ,002523.SZ,002524.SZ,002526.SZ,002527.SZ,002528.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_173 返回数据 row 行数 = "+str(stk_rewards_item_173.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_174 = pro.stk_rewards(ts_code='002529.SZ,002530.SZ,002531.SZ,002532.SZ,002533.SZ,002534.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_174 返回数据 row 行数 = "+str(stk_rewards_item_174.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_175 = pro.stk_rewards(ts_code='002535.SZ,002536.SZ,002537.SZ,002538.SZ,002539.SZ,002540.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_175 返回数据 row 行数 = "+str(stk_rewards_item_175.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_176 = pro.stk_rewards(ts_code='002541.SZ,002542.SZ,002543.SZ,002544.SZ,002545.SZ,002546.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_176 返回数据 row 行数 = "+str(stk_rewards_item_176.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_177 = pro.stk_rewards(ts_code='002547.SZ,002548.SZ,002549.SZ,002550.SZ,002551.SZ,002552.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_177 返回数据 row 行数 = "+str(stk_rewards_item_177.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_178 = pro.stk_rewards(ts_code='002553.SZ,002554.SZ,002555.SZ,002556.SZ,002557.SZ,002558.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_178 返回数据 row 行数 = "+str(stk_rewards_item_178.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_179 = pro.stk_rewards(ts_code='002559.SZ,002560.SZ,002561.SZ,002562.SZ,002563.SZ,002564.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_179 返回数据 row 行数 = "+str(stk_rewards_item_179.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_180 = pro.stk_rewards(ts_code='002565.SZ,002566.SZ,002567.SZ,002568.SZ,002569.SZ,002570.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_180 返回数据 row 行数 = "+str(stk_rewards_item_180.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_181 = pro.stk_rewards(ts_code='002571.SZ,002572.SZ,002573.SZ,002574.SZ,002575.SZ,002576.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_181 返回数据 row 行数 = "+str(stk_rewards_item_181.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_182 = pro.stk_rewards(ts_code='002577.SZ,002578.SZ,002579.SZ,002580.SZ,002581.SZ,002582.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_182 返回数据 row 行数 = "+str(stk_rewards_item_182.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_183 = pro.stk_rewards(ts_code='002583.SZ,002584.SZ,002585.SZ,002586.SZ,002587.SZ,002588.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_183 返回数据 row 行数 = "+str(stk_rewards_item_183.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_184 = pro.stk_rewards(ts_code='002589.SZ,002590.SZ,002591.SZ,002592.SZ,002593.SZ,002594.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_184 返回数据 row 行数 = "+str(stk_rewards_item_184.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_185 = pro.stk_rewards(ts_code='002595.SZ,002596.SZ,002597.SZ,002598.SZ,002599.SZ,002600.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_185 返回数据 row 行数 = "+str(stk_rewards_item_185.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_186 = pro.stk_rewards(ts_code='002601.SZ,002602.SZ,002603.SZ,002604.SZ,002605.SZ,002606.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_186 返回数据 row 行数 = "+str(stk_rewards_item_186.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_187 = pro.stk_rewards(ts_code='002607.SZ,002608.SZ,002609.SZ,002610.SZ,002611.SZ,002612.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_187 返回数据 row 行数 = "+str(stk_rewards_item_187.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_188 = pro.stk_rewards(ts_code='002613.SZ,002614.SZ,002615.SZ,002616.SZ,002617.SZ,002618.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_188 返回数据 row 行数 = "+str(stk_rewards_item_188.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_189 = pro.stk_rewards(ts_code='002619.SZ,002620.SZ,002621.SZ,002622.SZ,002623.SZ,002624.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_189 返回数据 row 行数 = "+str(stk_rewards_item_189.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_190 = pro.stk_rewards(ts_code='002625.SZ,002626.SZ,002627.SZ,002628.SZ,002629.SZ,002630.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_190 返回数据 row 行数 = "+str(stk_rewards_item_190.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_191 = pro.stk_rewards(ts_code='002631.SZ,002632.SZ,002633.SZ,002634.SZ,002635.SZ,002636.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_191 返回数据 row 行数 = "+str(stk_rewards_item_191.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_192 = pro.stk_rewards(ts_code='002637.SZ,002638.SZ,002639.SZ,002640.SZ,002641.SZ,002642.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_192 返回数据 row 行数 = "+str(stk_rewards_item_192.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_193 = pro.stk_rewards(ts_code='002643.SZ,002644.SZ,002645.SZ,002646.SZ,002647.SZ,002648.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_193 返回数据 row 行数 = "+str(stk_rewards_item_193.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_194 = pro.stk_rewards(ts_code='002649.SZ,002650.SZ,002651.SZ,002652.SZ,002653.SZ,002654.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_194 返回数据 row 行数 = "+str(stk_rewards_item_194.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_195 = pro.stk_rewards(ts_code='002655.SZ,002656.SZ,002657.SZ,002658.SZ,002659.SZ,002660.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_195 返回数据 row 行数 = "+str(stk_rewards_item_195.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_196 = pro.stk_rewards(ts_code='002661.SZ,002662.SZ,002663.SZ,002664.SZ,002665.SZ,002666.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_196 返回数据 row 行数 = "+str(stk_rewards_item_196.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_197 = pro.stk_rewards(ts_code='002667.SZ,002668.SZ,002669.SZ,002670.SZ,002671.SZ,002672.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_197 返回数据 row 行数 = "+str(stk_rewards_item_197.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_198 = pro.stk_rewards(ts_code='002673.SZ,002674.SZ,002675.SZ,002676.SZ,002677.SZ,002678.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_198 返回数据 row 行数 = "+str(stk_rewards_item_198.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_199 = pro.stk_rewards(ts_code='002679.SZ,002680.SZ,002681.SZ,002682.SZ,002683.SZ,002684.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_199 返回数据 row 行数 = "+str(stk_rewards_item_199.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_200 = pro.stk_rewards(ts_code='002685.SZ,002686.SZ,002687.SZ,002688.SZ,002689.SZ,002690.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_200 返回数据 row 行数 = "+str(stk_rewards_item_200.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_201 = pro.stk_rewards(ts_code='002691.SZ,002692.SZ,002693.SZ,002694.SZ,002695.SZ,002696.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_201 返回数据 row 行数 = "+str(stk_rewards_item_201.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_202 = pro.stk_rewards(ts_code='002697.SZ,002698.SZ,002699.SZ,002700.SZ,002701.SZ,002702.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_202 返回数据 row 行数 = "+str(stk_rewards_item_202.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_203 = pro.stk_rewards(ts_code='002703.SZ,002705.SZ,002706.SZ,002707.SZ,002708.SZ,002709.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_203 返回数据 row 行数 = "+str(stk_rewards_item_203.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_204 = pro.stk_rewards(ts_code='002711.SZ,002712.SZ,002713.SZ,002714.SZ,002715.SZ,002716.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_204 返回数据 row 行数 = "+str(stk_rewards_item_204.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_205 = pro.stk_rewards(ts_code='002717.SZ,002718.SZ,002719.SZ,002721.SZ,002722.SZ,002723.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_205 返回数据 row 行数 = "+str(stk_rewards_item_205.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_206 = pro.stk_rewards(ts_code='002724.SZ,002725.SZ,002726.SZ,002727.SZ,002728.SZ,002729.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_206 返回数据 row 行数 = "+str(stk_rewards_item_206.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_207 = pro.stk_rewards(ts_code='002730.SZ,002731.SZ,002732.SZ,002733.SZ,002734.SZ,002735.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_207 返回数据 row 行数 = "+str(stk_rewards_item_207.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_208 = pro.stk_rewards(ts_code='002736.SZ,002737.SZ,002738.SZ,002739.SZ,002740.SZ,002741.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_208 返回数据 row 行数 = "+str(stk_rewards_item_208.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_209 = pro.stk_rewards(ts_code='002742.SZ,002743.SZ,002745.SZ,002746.SZ,002747.SZ,002748.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_209 返回数据 row 行数 = "+str(stk_rewards_item_209.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_210 = pro.stk_rewards(ts_code='002749.SZ,002750.SZ,002751.SZ,002752.SZ,002753.SZ,002755.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_210 返回数据 row 行数 = "+str(stk_rewards_item_210.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_211 = pro.stk_rewards(ts_code='002756.SZ,002757.SZ,002758.SZ,002759.SZ,002760.SZ,002761.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_211 返回数据 row 行数 = "+str(stk_rewards_item_211.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_212 = pro.stk_rewards(ts_code='002762.SZ,002763.SZ,002765.SZ,002766.SZ,002767.SZ,002768.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_212 返回数据 row 行数 = "+str(stk_rewards_item_212.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_213 = pro.stk_rewards(ts_code='002769.SZ,002770.SZ,002771.SZ,002772.SZ,002773.SZ,002774.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_213 返回数据 row 行数 = "+str(stk_rewards_item_213.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_214 = pro.stk_rewards(ts_code='002775.SZ,002776.SZ,002777.SZ,002778.SZ,002779.SZ,002780.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_214 返回数据 row 行数 = "+str(stk_rewards_item_214.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_215 = pro.stk_rewards(ts_code='002781.SZ,002782.SZ,002783.SZ,002785.SZ,002786.SZ,002787.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_215 返回数据 row 行数 = "+str(stk_rewards_item_215.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_216 = pro.stk_rewards(ts_code='002788.SZ,002789.SZ,002790.SZ,002791.SZ,002792.SZ,002793.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_216 返回数据 row 行数 = "+str(stk_rewards_item_216.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_217 = pro.stk_rewards(ts_code='002795.SZ,002796.SZ,002797.SZ,002798.SZ,002799.SZ,002800.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_217 返回数据 row 行数 = "+str(stk_rewards_item_217.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_218 = pro.stk_rewards(ts_code='002801.SZ,002802.SZ,002803.SZ,002805.SZ,002806.SZ,002807.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_218 返回数据 row 行数 = "+str(stk_rewards_item_218.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_219 = pro.stk_rewards(ts_code='002808.SZ,002809.SZ,002810.SZ,002811.SZ,002812.SZ,002813.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_219 返回数据 row 行数 = "+str(stk_rewards_item_219.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_220 = pro.stk_rewards(ts_code='002815.SZ,002816.SZ,002817.SZ,002818.SZ,002819.SZ,002820.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_220 返回数据 row 行数 = "+str(stk_rewards_item_220.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_221 = pro.stk_rewards(ts_code='002821.SZ,002822.SZ,002823.SZ,002824.SZ,002825.SZ,002826.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_221 返回数据 row 行数 = "+str(stk_rewards_item_221.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_222 = pro.stk_rewards(ts_code='002827.SZ,002828.SZ,002829.SZ,002830.SZ,002831.SZ,002832.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_222 返回数据 row 行数 = "+str(stk_rewards_item_222.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_223 = pro.stk_rewards(ts_code='002833.SZ,002835.SZ,002836.SZ,002837.SZ,002838.SZ,002839.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_223 返回数据 row 行数 = "+str(stk_rewards_item_223.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_224 = pro.stk_rewards(ts_code='002840.SZ,002841.SZ,002842.SZ,002843.SZ,002845.SZ,002846.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_224 返回数据 row 行数 = "+str(stk_rewards_item_224.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_225 = pro.stk_rewards(ts_code='002847.SZ,002848.SZ,002849.SZ,002850.SZ,002851.SZ,002852.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_225 返回数据 row 行数 = "+str(stk_rewards_item_225.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_226 = pro.stk_rewards(ts_code='002853.SZ,002855.SZ,002856.SZ,002857.SZ,002858.SZ,002859.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_226 返回数据 row 行数 = "+str(stk_rewards_item_226.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_227 = pro.stk_rewards(ts_code='002860.SZ,002861.SZ,002862.SZ,002863.SZ,002864.SZ,002865.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_227 返回数据 row 行数 = "+str(stk_rewards_item_227.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_228 = pro.stk_rewards(ts_code='002866.SZ,002867.SZ,002868.SZ,002869.SZ,002870.SZ,002871.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_228 返回数据 row 行数 = "+str(stk_rewards_item_228.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_229 = pro.stk_rewards(ts_code='002872.SZ,002873.SZ,002875.SZ,002876.SZ,002877.SZ,002878.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_229 返回数据 row 行数 = "+str(stk_rewards_item_229.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_230 = pro.stk_rewards(ts_code='002879.SZ,002880.SZ,002881.SZ,002882.SZ,002883.SZ,002884.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_230 返回数据 row 行数 = "+str(stk_rewards_item_230.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_231 = pro.stk_rewards(ts_code='002885.SZ,002886.SZ,002887.SZ,002888.SZ,002889.SZ,002890.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_231 返回数据 row 行数 = "+str(stk_rewards_item_231.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_232 = pro.stk_rewards(ts_code='002891.SZ,002892.SZ,002893.SZ,002895.SZ,002896.SZ,002897.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_232 返回数据 row 行数 = "+str(stk_rewards_item_232.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_233 = pro.stk_rewards(ts_code='002898.SZ,002899.SZ,002900.SZ,002901.SZ,002902.SZ,002903.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_233 返回数据 row 行数 = "+str(stk_rewards_item_233.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_234 = pro.stk_rewards(ts_code='002905.SZ,002906.SZ,002907.SZ,002908.SZ,002909.SZ,002910.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_234 返回数据 row 行数 = "+str(stk_rewards_item_234.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_235 = pro.stk_rewards(ts_code='002911.SZ,002912.SZ,002913.SZ,002915.SZ,002916.SZ,002917.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_235 返回数据 row 行数 = "+str(stk_rewards_item_235.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_236 = pro.stk_rewards(ts_code='002918.SZ,002919.SZ,002920.SZ,002921.SZ,002922.SZ,002923.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_236 返回数据 row 行数 = "+str(stk_rewards_item_236.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_237 = pro.stk_rewards(ts_code='002925.SZ,002926.SZ,002927.SZ,002928.SZ,002929.SZ,002930.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_237 返回数据 row 行数 = "+str(stk_rewards_item_237.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_238 = pro.stk_rewards(ts_code='002931.SZ,002932.SZ,002933.SZ,002935.SZ,002936.SZ,002937.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_238 返回数据 row 行数 = "+str(stk_rewards_item_238.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_239 = pro.stk_rewards(ts_code='002938.SZ,002939.SZ,002940.SZ,002941.SZ,002942.SZ,002943.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_239 返回数据 row 行数 = "+str(stk_rewards_item_239.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_240 = pro.stk_rewards(ts_code='002945.SZ,002946.SZ,002947.SZ,002948.SZ,002949.SZ,002950.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_240 返回数据 row 行数 = "+str(stk_rewards_item_240.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_241 = pro.stk_rewards(ts_code='002951.SZ,002952.SZ,002953.SZ,002955.SZ,002956.SZ,002957.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_241 返回数据 row 行数 = "+str(stk_rewards_item_241.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_242 = pro.stk_rewards(ts_code='002958.SZ,002959.SZ,002960.SZ,002961.SZ,002962.SZ,002963.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_242 返回数据 row 行数 = "+str(stk_rewards_item_242.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_243 = pro.stk_rewards(ts_code='002965.SZ,002966.SZ,002967.SZ,002968.SZ,002969.SZ,002970.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_243 返回数据 row 行数 = "+str(stk_rewards_item_243.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_244 = pro.stk_rewards(ts_code='002971.SZ,002972.SZ,002973.SZ,002975.SZ,002976.SZ,002977.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_244 返回数据 row 行数 = "+str(stk_rewards_item_244.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_245 = pro.stk_rewards(ts_code='002978.SZ,002979.SZ,002980.SZ,002981.SZ,002982.SZ,002983.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_245 返回数据 row 行数 = "+str(stk_rewards_item_245.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_246 = pro.stk_rewards(ts_code='002984.SZ,002985.SZ,002986.SZ,002987.SZ,002988.SZ,002989.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_246 返回数据 row 行数 = "+str(stk_rewards_item_246.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_247 = pro.stk_rewards(ts_code='002990.SZ,002991.SZ,002992.SZ,002993.SZ,002995.SZ,002996.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_247 返回数据 row 行数 = "+str(stk_rewards_item_247.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_248 = pro.stk_rewards(ts_code='002997.SZ,002998.SZ,002999.SZ,003000.SZ,003001.SZ,003002.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_248 返回数据 row 行数 = "+str(stk_rewards_item_248.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_249 = pro.stk_rewards(ts_code='003003.SZ,003004.SZ,003005.SZ,003006.SZ,003007.SZ,003008.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_249 返回数据 row 行数 = "+str(stk_rewards_item_249.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_250 = pro.stk_rewards(ts_code='003009.SZ,003010.SZ,003011.SZ,003012.SZ,003013.SZ,003015.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_250 返回数据 row 行数 = "+str(stk_rewards_item_250.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_251 = pro.stk_rewards(ts_code='003016.SZ,003017.SZ,003018.SZ,003019.SZ,003020.SZ,003021.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_251 返回数据 row 行数 = "+str(stk_rewards_item_251.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_252 = pro.stk_rewards(ts_code='003022.SZ,003023.SZ,003025.SZ,003026.SZ,003027.SZ,003028.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_252 返回数据 row 行数 = "+str(stk_rewards_item_252.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_253 = pro.stk_rewards(ts_code='003029.SZ,003030.SZ,003031.SZ,003032.SZ,003033.SZ,003035.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_253 返回数据 row 行数 = "+str(stk_rewards_item_253.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_254 = pro.stk_rewards(ts_code='003036.SZ,003037.SZ,003038.SZ,003039.SZ,003040.SZ,003041.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_254 返回数据 row 行数 = "+str(stk_rewards_item_254.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_255 = pro.stk_rewards(ts_code='003042.SZ,003043.SZ,003816.SZ,300001.SZ,300002.SZ,300003.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_255 返回数据 row 行数 = "+str(stk_rewards_item_255.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_256 = pro.stk_rewards(ts_code='300004.SZ,300005.SZ,300006.SZ,300007.SZ,300008.SZ,300009.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_256 返回数据 row 行数 = "+str(stk_rewards_item_256.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_257 = pro.stk_rewards(ts_code='300010.SZ,300011.SZ,300012.SZ,300013.SZ,300014.SZ,300015.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_257 返回数据 row 行数 = "+str(stk_rewards_item_257.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_258 = pro.stk_rewards(ts_code='300016.SZ,300017.SZ,300018.SZ,300019.SZ,300020.SZ,300021.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_258 返回数据 row 行数 = "+str(stk_rewards_item_258.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_259 = pro.stk_rewards(ts_code='300022.SZ,300023.SZ,300024.SZ,300025.SZ,300026.SZ,300027.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_259 返回数据 row 行数 = "+str(stk_rewards_item_259.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_260 = pro.stk_rewards(ts_code='300028.SZ,300029.SZ,300030.SZ,300031.SZ,300032.SZ,300033.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_260 返回数据 row 行数 = "+str(stk_rewards_item_260.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_261 = pro.stk_rewards(ts_code='300034.SZ,300035.SZ,300036.SZ,300037.SZ,300038.SZ,300039.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_261 返回数据 row 行数 = "+str(stk_rewards_item_261.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_262 = pro.stk_rewards(ts_code='300040.SZ,300041.SZ,300042.SZ,300043.SZ,300044.SZ,300045.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_262 返回数据 row 行数 = "+str(stk_rewards_item_262.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_263 = pro.stk_rewards(ts_code='300046.SZ,300047.SZ,300048.SZ,300049.SZ,300050.SZ,300051.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_263 返回数据 row 行数 = "+str(stk_rewards_item_263.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_264 = pro.stk_rewards(ts_code='300052.SZ,300053.SZ,300054.SZ,300055.SZ,300056.SZ,300057.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_264 返回数据 row 行数 = "+str(stk_rewards_item_264.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_265 = pro.stk_rewards(ts_code='300058.SZ,300059.SZ,300061.SZ,300062.SZ,300063.SZ,300064.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_265 返回数据 row 行数 = "+str(stk_rewards_item_265.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_266 = pro.stk_rewards(ts_code='300065.SZ,300066.SZ,300067.SZ,300068.SZ,300069.SZ,300070.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_266 返回数据 row 行数 = "+str(stk_rewards_item_266.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_267 = pro.stk_rewards(ts_code='300071.SZ,300072.SZ,300073.SZ,300074.SZ,300075.SZ,300076.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_267 返回数据 row 行数 = "+str(stk_rewards_item_267.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_268 = pro.stk_rewards(ts_code='300077.SZ,300078.SZ,300079.SZ,300080.SZ,300081.SZ,300082.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_268 返回数据 row 行数 = "+str(stk_rewards_item_268.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_269 = pro.stk_rewards(ts_code='300083.SZ,300084.SZ,300085.SZ,300086.SZ,300087.SZ,300088.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_269 返回数据 row 行数 = "+str(stk_rewards_item_269.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_270 = pro.stk_rewards(ts_code='300089.SZ,300090.SZ,300091.SZ,300092.SZ,300093.SZ,300094.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_270 返回数据 row 行数 = "+str(stk_rewards_item_270.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_271 = pro.stk_rewards(ts_code='300095.SZ,300096.SZ,300097.SZ,300098.SZ,300099.SZ,300100.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_271 返回数据 row 行数 = "+str(stk_rewards_item_271.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_272 = pro.stk_rewards(ts_code='300101.SZ,300102.SZ,300103.SZ,300104.SZ,300105.SZ,300106.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_272 返回数据 row 行数 = "+str(stk_rewards_item_272.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_273 = pro.stk_rewards(ts_code='300107.SZ,300108.SZ,300109.SZ,300110.SZ,300111.SZ,300112.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_273 返回数据 row 行数 = "+str(stk_rewards_item_273.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_274 = pro.stk_rewards(ts_code='300113.SZ,300114.SZ,300115.SZ,300116.SZ,300117.SZ,300118.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_274 返回数据 row 行数 = "+str(stk_rewards_item_274.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_275 = pro.stk_rewards(ts_code='300119.SZ,300120.SZ,300121.SZ,300122.SZ,300123.SZ,300124.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_275 返回数据 row 行数 = "+str(stk_rewards_item_275.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_276 = pro.stk_rewards(ts_code='300125.SZ,300126.SZ,300127.SZ,300128.SZ,300129.SZ,300130.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_276 返回数据 row 行数 = "+str(stk_rewards_item_276.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_277 = pro.stk_rewards(ts_code='300131.SZ,300132.SZ,300133.SZ,300134.SZ,300135.SZ,300136.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_277 返回数据 row 行数 = "+str(stk_rewards_item_277.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_278 = pro.stk_rewards(ts_code='300137.SZ,300138.SZ,300139.SZ,300140.SZ,300141.SZ,300142.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_278 返回数据 row 行数 = "+str(stk_rewards_item_278.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_279 = pro.stk_rewards(ts_code='300143.SZ,300144.SZ,300145.SZ,300146.SZ,300147.SZ,300148.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_279 返回数据 row 行数 = "+str(stk_rewards_item_279.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_280 = pro.stk_rewards(ts_code='300149.SZ,300150.SZ,300151.SZ,300152.SZ,300153.SZ,300154.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_280 返回数据 row 行数 = "+str(stk_rewards_item_280.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_281 = pro.stk_rewards(ts_code='300155.SZ,300156.SZ,300157.SZ,300158.SZ,300159.SZ,300160.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_281 返回数据 row 行数 = "+str(stk_rewards_item_281.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_282 = pro.stk_rewards(ts_code='300161.SZ,300162.SZ,300163.SZ,300164.SZ,300165.SZ,300166.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_282 返回数据 row 行数 = "+str(stk_rewards_item_282.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_283 = pro.stk_rewards(ts_code='300167.SZ,300168.SZ,300169.SZ,300170.SZ,300171.SZ,300172.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_283 返回数据 row 行数 = "+str(stk_rewards_item_283.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_284 = pro.stk_rewards(ts_code='300173.SZ,300174.SZ,300175.SZ,300176.SZ,300177.SZ,300178.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_284 返回数据 row 行数 = "+str(stk_rewards_item_284.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_285 = pro.stk_rewards(ts_code='300179.SZ,300180.SZ,300181.SZ,300182.SZ,300183.SZ,300184.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_285 返回数据 row 行数 = "+str(stk_rewards_item_285.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_286 = pro.stk_rewards(ts_code='300185.SZ,300186.SZ,300187.SZ,300188.SZ,300189.SZ,300190.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_286 返回数据 row 行数 = "+str(stk_rewards_item_286.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_287 = pro.stk_rewards(ts_code='300191.SZ,300192.SZ,300193.SZ,300194.SZ,300195.SZ,300196.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_287 返回数据 row 行数 = "+str(stk_rewards_item_287.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_288 = pro.stk_rewards(ts_code='300197.SZ,300198.SZ,300199.SZ,300200.SZ,300201.SZ,300202.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_288 返回数据 row 行数 = "+str(stk_rewards_item_288.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_289 = pro.stk_rewards(ts_code='300203.SZ,300204.SZ,300205.SZ,300206.SZ,300207.SZ,300208.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_289 返回数据 row 行数 = "+str(stk_rewards_item_289.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_290 = pro.stk_rewards(ts_code='300209.SZ,300210.SZ,300211.SZ,300212.SZ,300213.SZ,300214.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_290 返回数据 row 行数 = "+str(stk_rewards_item_290.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_291 = pro.stk_rewards(ts_code='300215.SZ,300216.SZ,300217.SZ,300218.SZ,300219.SZ,300220.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_291 返回数据 row 行数 = "+str(stk_rewards_item_291.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_292 = pro.stk_rewards(ts_code='300221.SZ,300222.SZ,300223.SZ,300224.SZ,300225.SZ,300226.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_292 返回数据 row 行数 = "+str(stk_rewards_item_292.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_293 = pro.stk_rewards(ts_code='300227.SZ,300228.SZ,300229.SZ,300230.SZ,300231.SZ,300232.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_293 返回数据 row 行数 = "+str(stk_rewards_item_293.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_294 = pro.stk_rewards(ts_code='300233.SZ,300234.SZ,300235.SZ,300236.SZ,300237.SZ,300238.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_294 返回数据 row 行数 = "+str(stk_rewards_item_294.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_295 = pro.stk_rewards(ts_code='300239.SZ,300240.SZ,300241.SZ,300242.SZ,300243.SZ,300244.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_295 返回数据 row 行数 = "+str(stk_rewards_item_295.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_296 = pro.stk_rewards(ts_code='300245.SZ,300246.SZ,300247.SZ,300248.SZ,300249.SZ,300250.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_296 返回数据 row 行数 = "+str(stk_rewards_item_296.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_297 = pro.stk_rewards(ts_code='300251.SZ,300252.SZ,300253.SZ,300254.SZ,300255.SZ,300256.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_297 返回数据 row 行数 = "+str(stk_rewards_item_297.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_298 = pro.stk_rewards(ts_code='300257.SZ,300258.SZ,300259.SZ,300260.SZ,300261.SZ,300262.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_298 返回数据 row 行数 = "+str(stk_rewards_item_298.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_299 = pro.stk_rewards(ts_code='300263.SZ,300264.SZ,300265.SZ,300266.SZ,300267.SZ,300268.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_299 返回数据 row 行数 = "+str(stk_rewards_item_299.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_300 = pro.stk_rewards(ts_code='300269.SZ,300270.SZ,300271.SZ,300272.SZ,300273.SZ,300274.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_300 返回数据 row 行数 = "+str(stk_rewards_item_300.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_301 = pro.stk_rewards(ts_code='300275.SZ,300276.SZ,300277.SZ,300278.SZ,300279.SZ,300280.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_301 返回数据 row 行数 = "+str(stk_rewards_item_301.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_302 = pro.stk_rewards(ts_code='300281.SZ,300282.SZ,300283.SZ,300284.SZ,300285.SZ,300286.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_302 返回数据 row 行数 = "+str(stk_rewards_item_302.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_303 = pro.stk_rewards(ts_code='300287.SZ,300288.SZ,300289.SZ,300290.SZ,300291.SZ,300292.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_303 返回数据 row 行数 = "+str(stk_rewards_item_303.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_304 = pro.stk_rewards(ts_code='300293.SZ,300294.SZ,300295.SZ,300296.SZ,300297.SZ,300298.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_304 返回数据 row 行数 = "+str(stk_rewards_item_304.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_305 = pro.stk_rewards(ts_code='300299.SZ,300300.SZ,300301.SZ,300302.SZ,300303.SZ,300304.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_305 返回数据 row 行数 = "+str(stk_rewards_item_305.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_306 = pro.stk_rewards(ts_code='300305.SZ,300306.SZ,300307.SZ,300308.SZ,300309.SZ,300310.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_306 返回数据 row 行数 = "+str(stk_rewards_item_306.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_307 = pro.stk_rewards(ts_code='300311.SZ,300312.SZ,300313.SZ,300314.SZ,300315.SZ,300316.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_307 返回数据 row 行数 = "+str(stk_rewards_item_307.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_308 = pro.stk_rewards(ts_code='300317.SZ,300318.SZ,300319.SZ,300320.SZ,300321.SZ,300322.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_308 返回数据 row 行数 = "+str(stk_rewards_item_308.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_309 = pro.stk_rewards(ts_code='300323.SZ,300324.SZ,300325.SZ,300326.SZ,300327.SZ,300328.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_309 返回数据 row 行数 = "+str(stk_rewards_item_309.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_310 = pro.stk_rewards(ts_code='300329.SZ,300330.SZ,300331.SZ,300332.SZ,300333.SZ,300334.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_310 返回数据 row 行数 = "+str(stk_rewards_item_310.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_311 = pro.stk_rewards(ts_code='300335.SZ,300336.SZ,300337.SZ,300338.SZ,300339.SZ,300340.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_311 返回数据 row 行数 = "+str(stk_rewards_item_311.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_312 = pro.stk_rewards(ts_code='300341.SZ,300342.SZ,300343.SZ,300344.SZ,300345.SZ,300346.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_312 返回数据 row 行数 = "+str(stk_rewards_item_312.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_313 = pro.stk_rewards(ts_code='300347.SZ,300348.SZ,300349.SZ,300350.SZ,300351.SZ,300352.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_313 返回数据 row 行数 = "+str(stk_rewards_item_313.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_314 = pro.stk_rewards(ts_code='300353.SZ,300354.SZ,300355.SZ,300356.SZ,300357.SZ,300358.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_314 返回数据 row 行数 = "+str(stk_rewards_item_314.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_315 = pro.stk_rewards(ts_code='300359.SZ,300360.SZ,300362.SZ,300363.SZ,300364.SZ,300365.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_315 返回数据 row 行数 = "+str(stk_rewards_item_315.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_316 = pro.stk_rewards(ts_code='300366.SZ,300367.SZ,300368.SZ,300369.SZ,300370.SZ,300371.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_316 返回数据 row 行数 = "+str(stk_rewards_item_316.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_317 = pro.stk_rewards(ts_code='300372.SZ,300373.SZ,300374.SZ,300375.SZ,300376.SZ,300377.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_317 返回数据 row 行数 = "+str(stk_rewards_item_317.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_318 = pro.stk_rewards(ts_code='300378.SZ,300379.SZ,300380.SZ,300381.SZ,300382.SZ,300383.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_318 返回数据 row 行数 = "+str(stk_rewards_item_318.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_319 = pro.stk_rewards(ts_code='300384.SZ,300385.SZ,300386.SZ,300387.SZ,300388.SZ,300389.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_319 返回数据 row 行数 = "+str(stk_rewards_item_319.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_320 = pro.stk_rewards(ts_code='300390.SZ,300391.SZ,300392.SZ,300393.SZ,300394.SZ,300395.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_320 返回数据 row 行数 = "+str(stk_rewards_item_320.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_321 = pro.stk_rewards(ts_code='300396.SZ,300397.SZ,300398.SZ,300399.SZ,300400.SZ,300401.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_321 返回数据 row 行数 = "+str(stk_rewards_item_321.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_322 = pro.stk_rewards(ts_code='300402.SZ,300403.SZ,300404.SZ,300405.SZ,300406.SZ,300407.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_322 返回数据 row 行数 = "+str(stk_rewards_item_322.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_323 = pro.stk_rewards(ts_code='300408.SZ,300409.SZ,300410.SZ,300411.SZ,300412.SZ,300413.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_323 返回数据 row 行数 = "+str(stk_rewards_item_323.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_324 = pro.stk_rewards(ts_code='300414.SZ,300415.SZ,300416.SZ,300417.SZ,300418.SZ,300419.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_324 返回数据 row 行数 = "+str(stk_rewards_item_324.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_325 = pro.stk_rewards(ts_code='300420.SZ,300421.SZ,300422.SZ,300423.SZ,300424.SZ,300425.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_325 返回数据 row 行数 = "+str(stk_rewards_item_325.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_326 = pro.stk_rewards(ts_code='300426.SZ,300427.SZ,300428.SZ,300429.SZ,300430.SZ,300431.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_326 返回数据 row 行数 = "+str(stk_rewards_item_326.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_327 = pro.stk_rewards(ts_code='300432.SZ,300433.SZ,300434.SZ,300435.SZ,300436.SZ,300437.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_327 返回数据 row 行数 = "+str(stk_rewards_item_327.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_328 = pro.stk_rewards(ts_code='300438.SZ,300439.SZ,300440.SZ,300441.SZ,300442.SZ,300443.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_328 返回数据 row 行数 = "+str(stk_rewards_item_328.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_329 = pro.stk_rewards(ts_code='300444.SZ,300445.SZ,300446.SZ,300447.SZ,300448.SZ,300449.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_329 返回数据 row 行数 = "+str(stk_rewards_item_329.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_330 = pro.stk_rewards(ts_code='300450.SZ,300451.SZ,300452.SZ,300453.SZ,300454.SZ,300455.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_330 返回数据 row 行数 = "+str(stk_rewards_item_330.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_331 = pro.stk_rewards(ts_code='300456.SZ,300457.SZ,300458.SZ,300459.SZ,300460.SZ,300461.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_331 返回数据 row 行数 = "+str(stk_rewards_item_331.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_332 = pro.stk_rewards(ts_code='300462.SZ,300463.SZ,300464.SZ,300465.SZ,300466.SZ,300467.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_332 返回数据 row 行数 = "+str(stk_rewards_item_332.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_333 = pro.stk_rewards(ts_code='300468.SZ,300469.SZ,300470.SZ,300471.SZ,300472.SZ,300473.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_333 返回数据 row 行数 = "+str(stk_rewards_item_333.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_334 = pro.stk_rewards(ts_code='300474.SZ,300475.SZ,300476.SZ,300477.SZ,300478.SZ,300479.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_334 返回数据 row 行数 = "+str(stk_rewards_item_334.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_335 = pro.stk_rewards(ts_code='300480.SZ,300481.SZ,300482.SZ,300483.SZ,300484.SZ,300485.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_335 返回数据 row 行数 = "+str(stk_rewards_item_335.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_336 = pro.stk_rewards(ts_code='300486.SZ,300487.SZ,300488.SZ,300489.SZ,300490.SZ,300491.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_336 返回数据 row 行数 = "+str(stk_rewards_item_336.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_337 = pro.stk_rewards(ts_code='300492.SZ,300493.SZ,300494.SZ,300495.SZ,300496.SZ,300497.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_337 返回数据 row 行数 = "+str(stk_rewards_item_337.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_338 = pro.stk_rewards(ts_code='300498.SZ,300499.SZ,300500.SZ,300501.SZ,300502.SZ,300503.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_338 返回数据 row 行数 = "+str(stk_rewards_item_338.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_339 = pro.stk_rewards(ts_code='300504.SZ,300505.SZ,300506.SZ,300507.SZ,300508.SZ,300509.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_339 返回数据 row 行数 = "+str(stk_rewards_item_339.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_340 = pro.stk_rewards(ts_code='300510.SZ,300511.SZ,300512.SZ,300513.SZ,300514.SZ,300515.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_340 返回数据 row 行数 = "+str(stk_rewards_item_340.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_341 = pro.stk_rewards(ts_code='300516.SZ,300517.SZ,300518.SZ,300519.SZ,300520.SZ,300521.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_341 返回数据 row 行数 = "+str(stk_rewards_item_341.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_342 = pro.stk_rewards(ts_code='300522.SZ,300523.SZ,300525.SZ,300526.SZ,300527.SZ,300528.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_342 返回数据 row 行数 = "+str(stk_rewards_item_342.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_343 = pro.stk_rewards(ts_code='300529.SZ,300530.SZ,300531.SZ,300532.SZ,300533.SZ,300534.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_343 返回数据 row 行数 = "+str(stk_rewards_item_343.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_344 = pro.stk_rewards(ts_code='300535.SZ,300536.SZ,300537.SZ,300538.SZ,300539.SZ,300540.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_344 返回数据 row 行数 = "+str(stk_rewards_item_344.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_345 = pro.stk_rewards(ts_code='300541.SZ,300542.SZ,300543.SZ,300545.SZ,300546.SZ,300547.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_345 返回数据 row 行数 = "+str(stk_rewards_item_345.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_346 = pro.stk_rewards(ts_code='300548.SZ,300549.SZ,300550.SZ,300551.SZ,300552.SZ,300553.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_346 返回数据 row 行数 = "+str(stk_rewards_item_346.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_347 = pro.stk_rewards(ts_code='300554.SZ,300555.SZ,300556.SZ,300557.SZ,300558.SZ,300559.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_347 返回数据 row 行数 = "+str(stk_rewards_item_347.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_348 = pro.stk_rewards(ts_code='300560.SZ,300561.SZ,300562.SZ,300563.SZ,300564.SZ,300565.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_348 返回数据 row 行数 = "+str(stk_rewards_item_348.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_349 = pro.stk_rewards(ts_code='300566.SZ,300567.SZ,300568.SZ,300569.SZ,300570.SZ,300571.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_349 返回数据 row 行数 = "+str(stk_rewards_item_349.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_350 = pro.stk_rewards(ts_code='300572.SZ,300573.SZ,300575.SZ,300576.SZ,300577.SZ,300578.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_350 返回数据 row 行数 = "+str(stk_rewards_item_350.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_351 = pro.stk_rewards(ts_code='300579.SZ,300580.SZ,300581.SZ,300582.SZ,300583.SZ,300584.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_351 返回数据 row 行数 = "+str(stk_rewards_item_351.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_352 = pro.stk_rewards(ts_code='300585.SZ,300586.SZ,300587.SZ,300588.SZ,300589.SZ,300590.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_352 返回数据 row 行数 = "+str(stk_rewards_item_352.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_353 = pro.stk_rewards(ts_code='300591.SZ,300592.SZ,300593.SZ,300594.SZ,300595.SZ,300596.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_353 返回数据 row 行数 = "+str(stk_rewards_item_353.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_354 = pro.stk_rewards(ts_code='300597.SZ,300598.SZ,300599.SZ,300600.SZ,300601.SZ,300602.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_354 返回数据 row 行数 = "+str(stk_rewards_item_354.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_355 = pro.stk_rewards(ts_code='300603.SZ,300604.SZ,300605.SZ,300606.SZ,300607.SZ,300608.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_355 返回数据 row 行数 = "+str(stk_rewards_item_355.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_356 = pro.stk_rewards(ts_code='300609.SZ,300610.SZ,300611.SZ,300612.SZ,300613.SZ,300614.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_356 返回数据 row 行数 = "+str(stk_rewards_item_356.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_357 = pro.stk_rewards(ts_code='300615.SZ,300616.SZ,300617.SZ,300618.SZ,300619.SZ,300620.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_357 返回数据 row 行数 = "+str(stk_rewards_item_357.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_358 = pro.stk_rewards(ts_code='300621.SZ,300622.SZ,300623.SZ,300624.SZ,300625.SZ,300626.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_358 返回数据 row 行数 = "+str(stk_rewards_item_358.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_359 = pro.stk_rewards(ts_code='300627.SZ,300628.SZ,300629.SZ,300630.SZ,300631.SZ,300632.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_359 返回数据 row 行数 = "+str(stk_rewards_item_359.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_360 = pro.stk_rewards(ts_code='300633.SZ,300634.SZ,300635.SZ,300636.SZ,300637.SZ,300638.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_360 返回数据 row 行数 = "+str(stk_rewards_item_360.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_361 = pro.stk_rewards(ts_code='300639.SZ,300640.SZ,300641.SZ,300642.SZ,300643.SZ,300644.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_361 返回数据 row 行数 = "+str(stk_rewards_item_361.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_362 = pro.stk_rewards(ts_code='300645.SZ,300647.SZ,300648.SZ,300649.SZ,300650.SZ,300651.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_362 返回数据 row 行数 = "+str(stk_rewards_item_362.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_363 = pro.stk_rewards(ts_code='300652.SZ,300653.SZ,300654.SZ,300655.SZ,300656.SZ,300657.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_363 返回数据 row 行数 = "+str(stk_rewards_item_363.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_364 = pro.stk_rewards(ts_code='300658.SZ,300659.SZ,300660.SZ,300661.SZ,300662.SZ,300663.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_364 返回数据 row 行数 = "+str(stk_rewards_item_364.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_365 = pro.stk_rewards(ts_code='300664.SZ,300665.SZ,300666.SZ,300667.SZ,300668.SZ,300669.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_365 返回数据 row 行数 = "+str(stk_rewards_item_365.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_366 = pro.stk_rewards(ts_code='300670.SZ,300671.SZ,300672.SZ,300673.SZ,300674.SZ,300675.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_366 返回数据 row 行数 = "+str(stk_rewards_item_366.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_367 = pro.stk_rewards(ts_code='300676.SZ,300677.SZ,300678.SZ,300679.SZ,300680.SZ,300681.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_367 返回数据 row 行数 = "+str(stk_rewards_item_367.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_368 = pro.stk_rewards(ts_code='300682.SZ,300683.SZ,300684.SZ,300685.SZ,300686.SZ,300687.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_368 返回数据 row 行数 = "+str(stk_rewards_item_368.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_369 = pro.stk_rewards(ts_code='300688.SZ,300689.SZ,300690.SZ,300691.SZ,300692.SZ,300693.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_369 返回数据 row 行数 = "+str(stk_rewards_item_369.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_370 = pro.stk_rewards(ts_code='300694.SZ,300695.SZ,300696.SZ,300697.SZ,300698.SZ,300699.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_370 返回数据 row 行数 = "+str(stk_rewards_item_370.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_371 = pro.stk_rewards(ts_code='300700.SZ,300701.SZ,300702.SZ,300703.SZ,300705.SZ,300706.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_371 返回数据 row 行数 = "+str(stk_rewards_item_371.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_372 = pro.stk_rewards(ts_code='300707.SZ,300708.SZ,300709.SZ,300710.SZ,300711.SZ,300712.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_372 返回数据 row 行数 = "+str(stk_rewards_item_372.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_373 = pro.stk_rewards(ts_code='300713.SZ,300715.SZ,300716.SZ,300717.SZ,300718.SZ,300719.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_373 返回数据 row 行数 = "+str(stk_rewards_item_373.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_374 = pro.stk_rewards(ts_code='300720.SZ,300721.SZ,300722.SZ,300723.SZ,300724.SZ,300725.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_374 返回数据 row 行数 = "+str(stk_rewards_item_374.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_375 = pro.stk_rewards(ts_code='300726.SZ,300727.SZ,300729.SZ,300730.SZ,300731.SZ,300732.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_375 返回数据 row 行数 = "+str(stk_rewards_item_375.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_376 = pro.stk_rewards(ts_code='300733.SZ,300735.SZ,300736.SZ,300737.SZ,300738.SZ,300739.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_376 返回数据 row 行数 = "+str(stk_rewards_item_376.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_377 = pro.stk_rewards(ts_code='300740.SZ,300741.SZ,300742.SZ,300743.SZ,300745.SZ,300746.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_377 返回数据 row 行数 = "+str(stk_rewards_item_377.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_378 = pro.stk_rewards(ts_code='300747.SZ,300748.SZ,300749.SZ,300750.SZ,300751.SZ,300752.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_378 返回数据 row 行数 = "+str(stk_rewards_item_378.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_379 = pro.stk_rewards(ts_code='300753.SZ,300755.SZ,300756.SZ,300757.SZ,300758.SZ,300759.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_379 返回数据 row 行数 = "+str(stk_rewards_item_379.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_380 = pro.stk_rewards(ts_code='300760.SZ,300761.SZ,300762.SZ,300763.SZ,300765.SZ,300766.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_380 返回数据 row 行数 = "+str(stk_rewards_item_380.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_381 = pro.stk_rewards(ts_code='300767.SZ,300768.SZ,300769.SZ,300770.SZ,300771.SZ,300772.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_381 返回数据 row 行数 = "+str(stk_rewards_item_381.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_382 = pro.stk_rewards(ts_code='300773.SZ,300775.SZ,300776.SZ,300777.SZ,300778.SZ,300779.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_382 返回数据 row 行数 = "+str(stk_rewards_item_382.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_383 = pro.stk_rewards(ts_code='300780.SZ,300781.SZ,300782.SZ,300783.SZ,300785.SZ,300786.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_383 返回数据 row 行数 = "+str(stk_rewards_item_383.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_384 = pro.stk_rewards(ts_code='300787.SZ,300788.SZ,300789.SZ,300790.SZ,300791.SZ,300792.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_384 返回数据 row 行数 = "+str(stk_rewards_item_384.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_385 = pro.stk_rewards(ts_code='300793.SZ,300795.SZ,300796.SZ,300797.SZ,300798.SZ,300799.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_385 返回数据 row 行数 = "+str(stk_rewards_item_385.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_386 = pro.stk_rewards(ts_code='300800.SZ,300801.SZ,300802.SZ,300803.SZ,300805.SZ,300806.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_386 返回数据 row 行数 = "+str(stk_rewards_item_386.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_387 = pro.stk_rewards(ts_code='300807.SZ,300808.SZ,300809.SZ,300810.SZ,300811.SZ,300812.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_387 返回数据 row 行数 = "+str(stk_rewards_item_387.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_388 = pro.stk_rewards(ts_code='300813.SZ,300815.SZ,300816.SZ,300817.SZ,300818.SZ,300819.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_388 返回数据 row 行数 = "+str(stk_rewards_item_388.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_389 = pro.stk_rewards(ts_code='300820.SZ,300821.SZ,300822.SZ,300823.SZ,300824.SZ,300825.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_389 返回数据 row 行数 = "+str(stk_rewards_item_389.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_390 = pro.stk_rewards(ts_code='300826.SZ,300827.SZ,300828.SZ,300829.SZ,300830.SZ,300831.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_390 返回数据 row 行数 = "+str(stk_rewards_item_390.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_391 = pro.stk_rewards(ts_code='300832.SZ,300833.SZ,300835.SZ,300836.SZ,300837.SZ,300838.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_391 返回数据 row 行数 = "+str(stk_rewards_item_391.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_392 = pro.stk_rewards(ts_code='300839.SZ,300840.SZ,300841.SZ,300842.SZ,300843.SZ,300845.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_392 返回数据 row 行数 = "+str(stk_rewards_item_392.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_393 = pro.stk_rewards(ts_code='300846.SZ,300847.SZ,300848.SZ,300849.SZ,300850.SZ,300851.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_393 返回数据 row 行数 = "+str(stk_rewards_item_393.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_394 = pro.stk_rewards(ts_code='300852.SZ,300853.SZ,300855.SZ,300856.SZ,300857.SZ,300858.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_394 返回数据 row 行数 = "+str(stk_rewards_item_394.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_395 = pro.stk_rewards(ts_code='300859.SZ,300860.SZ,300861.SZ,300862.SZ,300863.SZ,300864.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_395 返回数据 row 行数 = "+str(stk_rewards_item_395.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_396 = pro.stk_rewards(ts_code='300865.SZ,300866.SZ,300867.SZ,300868.SZ,300869.SZ,300870.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_396 返回数据 row 行数 = "+str(stk_rewards_item_396.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_397 = pro.stk_rewards(ts_code='300871.SZ,300872.SZ,300873.SZ,300875.SZ,300876.SZ,300877.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_397 返回数据 row 行数 = "+str(stk_rewards_item_397.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_398 = pro.stk_rewards(ts_code='300878.SZ,300879.SZ,300880.SZ,300881.SZ,300882.SZ,300883.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_398 返回数据 row 行数 = "+str(stk_rewards_item_398.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_399 = pro.stk_rewards(ts_code='300884.SZ,300885.SZ,300886.SZ,300887.SZ,300888.SZ,300889.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_399 返回数据 row 行数 = "+str(stk_rewards_item_399.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_400 = pro.stk_rewards(ts_code='300890.SZ,300891.SZ,300892.SZ,300893.SZ,300894.SZ,300895.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_400 返回数据 row 行数 = "+str(stk_rewards_item_400.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_401 = pro.stk_rewards(ts_code='300896.SZ,300897.SZ,300898.SZ,300899.SZ,300900.SZ,300901.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_401 返回数据 row 行数 = "+str(stk_rewards_item_401.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_402 = pro.stk_rewards(ts_code='300902.SZ,300903.SZ,300905.SZ,300906.SZ,300907.SZ,300908.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_402 返回数据 row 行数 = "+str(stk_rewards_item_402.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_403 = pro.stk_rewards(ts_code='300909.SZ,300910.SZ,300911.SZ,300912.SZ,300913.SZ,300915.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_403 返回数据 row 行数 = "+str(stk_rewards_item_403.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_404 = pro.stk_rewards(ts_code='300916.SZ,300917.SZ,300918.SZ,300919.SZ,300920.SZ,300921.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_404 返回数据 row 行数 = "+str(stk_rewards_item_404.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_405 = pro.stk_rewards(ts_code='300922.SZ,300923.SZ,300925.SZ,300926.SZ,300927.SZ,300928.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_405 返回数据 row 行数 = "+str(stk_rewards_item_405.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_406 = pro.stk_rewards(ts_code='300929.SZ,300930.SZ,300931.SZ,300932.SZ,300933.SZ,300935.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_406 返回数据 row 行数 = "+str(stk_rewards_item_406.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_407 = pro.stk_rewards(ts_code='300936.SZ,300937.SZ,300938.SZ,300939.SZ,300940.SZ,300941.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_407 返回数据 row 行数 = "+str(stk_rewards_item_407.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_408 = pro.stk_rewards(ts_code='300942.SZ,300943.SZ,300945.SZ,300946.SZ,300947.SZ,300948.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_408 返回数据 row 行数 = "+str(stk_rewards_item_408.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_409 = pro.stk_rewards(ts_code='300949.SZ,300950.SZ,300951.SZ,300952.SZ,300953.SZ,300955.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_409 返回数据 row 行数 = "+str(stk_rewards_item_409.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_410 = pro.stk_rewards(ts_code='300956.SZ,300957.SZ,300958.SZ,300959.SZ,300960.SZ,300961.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_410 返回数据 row 行数 = "+str(stk_rewards_item_410.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_411 = pro.stk_rewards(ts_code='300962.SZ,300963.SZ,300965.SZ,300966.SZ,300967.SZ,300968.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_411 返回数据 row 行数 = "+str(stk_rewards_item_411.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_412 = pro.stk_rewards(ts_code='300969.SZ,300970.SZ,300971.SZ,300972.SZ,300973.SZ,300975.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_412 返回数据 row 行数 = "+str(stk_rewards_item_412.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_413 = pro.stk_rewards(ts_code='300976.SZ,300977.SZ,300978.SZ,300979.SZ,300980.SZ,300981.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_413 返回数据 row 行数 = "+str(stk_rewards_item_413.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_414 = pro.stk_rewards(ts_code='300982.SZ,300983.SZ,300984.SZ,300985.SZ,300986.SZ,300987.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_414 返回数据 row 行数 = "+str(stk_rewards_item_414.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_415 = pro.stk_rewards(ts_code='300988.SZ,300989.SZ,300990.SZ,300991.SZ,300992.SZ,300993.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_415 返回数据 row 行数 = "+str(stk_rewards_item_415.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_416 = pro.stk_rewards(ts_code='300995.SZ,300996.SZ,300997.SZ,300998.SZ,300999.SZ,301000.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_416 返回数据 row 行数 = "+str(stk_rewards_item_416.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_417 = pro.stk_rewards(ts_code='301001.SZ,301002.SZ,301003.SZ,301004.SZ,301005.SZ,301006.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_417 返回数据 row 行数 = "+str(stk_rewards_item_417.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_418 = pro.stk_rewards(ts_code='301007.SZ,301008.SZ,301009.SZ,301010.SZ,301011.SZ,301012.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_418 返回数据 row 行数 = "+str(stk_rewards_item_418.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_419 = pro.stk_rewards(ts_code='301013.SZ,301015.SZ,301016.SZ,301017.SZ,301018.SZ,301019.SZ', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_419 返回数据 row 行数 = "+str(stk_rewards_item_419.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_420 = pro.stk_rewards(ts_code='301020.SZ,301021.SZ,301022.SZ,301023.SZ,600000.SH,600001.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_420 返回数据 row 行数 = "+str(stk_rewards_item_420.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_421 = pro.stk_rewards(ts_code='600002.SH,600003.SH,600004.SH,600005.SH,600006.SH,600007.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_421 返回数据 row 行数 = "+str(stk_rewards_item_421.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_422 = pro.stk_rewards(ts_code='600008.SH,600009.SH,600010.SH,600011.SH,600012.SH,600015.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_422 返回数据 row 行数 = "+str(stk_rewards_item_422.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_423 = pro.stk_rewards(ts_code='600016.SH,600017.SH,600018.SH,600019.SH,600020.SH,600021.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_423 返回数据 row 行数 = "+str(stk_rewards_item_423.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_424 = pro.stk_rewards(ts_code='600022.SH,600023.SH,600025.SH,600026.SH,600027.SH,600028.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_424 返回数据 row 行数 = "+str(stk_rewards_item_424.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_425 = pro.stk_rewards(ts_code='600029.SH,600030.SH,600031.SH,600032.SH,600033.SH,600035.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_425 返回数据 row 行数 = "+str(stk_rewards_item_425.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_426 = pro.stk_rewards(ts_code='600036.SH,600037.SH,600038.SH,600039.SH,600048.SH,600050.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_426 返回数据 row 行数 = "+str(stk_rewards_item_426.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_427 = pro.stk_rewards(ts_code='600051.SH,600052.SH,600053.SH,600054.SH,600055.SH,600056.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_427 返回数据 row 行数 = "+str(stk_rewards_item_427.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_428 = pro.stk_rewards(ts_code='600057.SH,600058.SH,600059.SH,600060.SH,600061.SH,600062.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_428 返回数据 row 行数 = "+str(stk_rewards_item_428.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_429 = pro.stk_rewards(ts_code='600063.SH,600064.SH,600065.SH,600066.SH,600067.SH,600068.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_429 返回数据 row 行数 = "+str(stk_rewards_item_429.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_430 = pro.stk_rewards(ts_code='600069.SH,600070.SH,600071.SH,600072.SH,600073.SH,600074.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_430 返回数据 row 行数 = "+str(stk_rewards_item_430.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_431 = pro.stk_rewards(ts_code='600075.SH,600076.SH,600077.SH,600078.SH,600079.SH,600080.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_431 返回数据 row 行数 = "+str(stk_rewards_item_431.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_432 = pro.stk_rewards(ts_code='600081.SH,600082.SH,600083.SH,600084.SH,600085.SH,600086.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_432 返回数据 row 行数 = "+str(stk_rewards_item_432.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_433 = pro.stk_rewards(ts_code='600087.SH,600088.SH,600089.SH,600090.SH,600091.SH,600092.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_433 返回数据 row 行数 = "+str(stk_rewards_item_433.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_434 = pro.stk_rewards(ts_code='600093.SH,600094.SH,600095.SH,600096.SH,600097.SH,600098.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_434 返回数据 row 行数 = "+str(stk_rewards_item_434.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_435 = pro.stk_rewards(ts_code='600099.SH,600100.SH,600101.SH,600102.SH,600103.SH,600104.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_435 返回数据 row 行数 = "+str(stk_rewards_item_435.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_436 = pro.stk_rewards(ts_code='600105.SH,600106.SH,600107.SH,600108.SH,600109.SH,600110.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_436 返回数据 row 行数 = "+str(stk_rewards_item_436.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_437 = pro.stk_rewards(ts_code='600111.SH,600112.SH,600113.SH,600114.SH,600115.SH,600116.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_437 返回数据 row 行数 = "+str(stk_rewards_item_437.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_438 = pro.stk_rewards(ts_code='600117.SH,600118.SH,600119.SH,600120.SH,600121.SH,600122.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_438 返回数据 row 行数 = "+str(stk_rewards_item_438.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_439 = pro.stk_rewards(ts_code='600123.SH,600125.SH,600126.SH,600127.SH,600128.SH,600129.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_439 返回数据 row 行数 = "+str(stk_rewards_item_439.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_440 = pro.stk_rewards(ts_code='600130.SH,600131.SH,600132.SH,600133.SH,600135.SH,600136.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_440 返回数据 row 行数 = "+str(stk_rewards_item_440.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_441 = pro.stk_rewards(ts_code='600137.SH,600138.SH,600139.SH,600141.SH,600143.SH,600145.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_441 返回数据 row 行数 = "+str(stk_rewards_item_441.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_442 = pro.stk_rewards(ts_code='600146.SH,600148.SH,600149.SH,600150.SH,600151.SH,600152.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_442 返回数据 row 行数 = "+str(stk_rewards_item_442.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_443 = pro.stk_rewards(ts_code='600153.SH,600155.SH,600156.SH,600157.SH,600158.SH,600159.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_443 返回数据 row 行数 = "+str(stk_rewards_item_443.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_444 = pro.stk_rewards(ts_code='600160.SH,600161.SH,600162.SH,600163.SH,600165.SH,600166.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_444 返回数据 row 行数 = "+str(stk_rewards_item_444.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_445 = pro.stk_rewards(ts_code='600167.SH,600168.SH,600169.SH,600170.SH,600171.SH,600172.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_445 返回数据 row 行数 = "+str(stk_rewards_item_445.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_446 = pro.stk_rewards(ts_code='600173.SH,600175.SH,600176.SH,600177.SH,600178.SH,600179.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_446 返回数据 row 行数 = "+str(stk_rewards_item_446.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_447 = pro.stk_rewards(ts_code='600180.SH,600181.SH,600182.SH,600183.SH,600184.SH,600185.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_447 返回数据 row 行数 = "+str(stk_rewards_item_447.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_448 = pro.stk_rewards(ts_code='600186.SH,600187.SH,600188.SH,600189.SH,600190.SH,600191.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_448 返回数据 row 行数 = "+str(stk_rewards_item_448.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_449 = pro.stk_rewards(ts_code='600192.SH,600193.SH,600195.SH,600196.SH,600197.SH,600198.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_449 返回数据 row 行数 = "+str(stk_rewards_item_449.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_450 = pro.stk_rewards(ts_code='600199.SH,600200.SH,600201.SH,600202.SH,600203.SH,600205.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_450 返回数据 row 行数 = "+str(stk_rewards_item_450.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_451 = pro.stk_rewards(ts_code='600206.SH,600207.SH,600208.SH,600209.SH,600210.SH,600211.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_451 返回数据 row 行数 = "+str(stk_rewards_item_451.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_452 = pro.stk_rewards(ts_code='600212.SH,600213.SH,600215.SH,600216.SH,600217.SH,600218.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_452 返回数据 row 行数 = "+str(stk_rewards_item_452.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_453 = pro.stk_rewards(ts_code='600219.SH,600220.SH,600221.SH,600222.SH,600223.SH,600225.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_453 返回数据 row 行数 = "+str(stk_rewards_item_453.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_454 = pro.stk_rewards(ts_code='600226.SH,600227.SH,600228.SH,600229.SH,600230.SH,600231.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_454 返回数据 row 行数 = "+str(stk_rewards_item_454.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_455 = pro.stk_rewards(ts_code='600232.SH,600233.SH,600234.SH,600235.SH,600236.SH,600237.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_455 返回数据 row 行数 = "+str(stk_rewards_item_455.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_456 = pro.stk_rewards(ts_code='600238.SH,600239.SH,600240.SH,600241.SH,600242.SH,600243.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_456 返回数据 row 行数 = "+str(stk_rewards_item_456.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_457 = pro.stk_rewards(ts_code='600246.SH,600247.SH,600248.SH,600249.SH,600250.SH,600251.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_457 返回数据 row 行数 = "+str(stk_rewards_item_457.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_458 = pro.stk_rewards(ts_code='600252.SH,600253.SH,600255.SH,600256.SH,600257.SH,600258.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_458 返回数据 row 行数 = "+str(stk_rewards_item_458.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_459 = pro.stk_rewards(ts_code='600259.SH,600260.SH,600261.SH,600262.SH,600263.SH,600265.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_459 返回数据 row 行数 = "+str(stk_rewards_item_459.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_460 = pro.stk_rewards(ts_code='600266.SH,600267.SH,600268.SH,600269.SH,600270.SH,600271.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_460 返回数据 row 行数 = "+str(stk_rewards_item_460.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_461 = pro.stk_rewards(ts_code='600272.SH,600273.SH,600275.SH,600276.SH,600277.SH,600278.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_461 返回数据 row 行数 = "+str(stk_rewards_item_461.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_462 = pro.stk_rewards(ts_code='600279.SH,600280.SH,600281.SH,600282.SH,600283.SH,600284.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_462 返回数据 row 行数 = "+str(stk_rewards_item_462.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_463 = pro.stk_rewards(ts_code='600285.SH,600286.SH,600287.SH,600288.SH,600289.SH,600290.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_463 返回数据 row 行数 = "+str(stk_rewards_item_463.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_464 = pro.stk_rewards(ts_code='600291.SH,600292.SH,600293.SH,600295.SH,600296.SH,600297.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_464 返回数据 row 行数 = "+str(stk_rewards_item_464.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_465 = pro.stk_rewards(ts_code='600298.SH,600299.SH,600300.SH,600301.SH,600302.SH,600303.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_465 返回数据 row 行数 = "+str(stk_rewards_item_465.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_466 = pro.stk_rewards(ts_code='600305.SH,600306.SH,600307.SH,600308.SH,600309.SH,600310.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_466 返回数据 row 行数 = "+str(stk_rewards_item_466.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_467 = pro.stk_rewards(ts_code='600311.SH,600312.SH,600313.SH,600315.SH,600316.SH,600317.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_467 返回数据 row 行数 = "+str(stk_rewards_item_467.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_468 = pro.stk_rewards(ts_code='600318.SH,600319.SH,600320.SH,600321.SH,600322.SH,600323.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_468 返回数据 row 行数 = "+str(stk_rewards_item_468.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_469 = pro.stk_rewards(ts_code='600325.SH,600326.SH,600327.SH,600328.SH,600329.SH,600330.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_469 返回数据 row 行数 = "+str(stk_rewards_item_469.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_470 = pro.stk_rewards(ts_code='600331.SH,600332.SH,600333.SH,600335.SH,600336.SH,600337.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_470 返回数据 row 行数 = "+str(stk_rewards_item_470.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_471 = pro.stk_rewards(ts_code='600338.SH,600339.SH,600340.SH,600343.SH,600345.SH,600346.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_471 返回数据 row 行数 = "+str(stk_rewards_item_471.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_472 = pro.stk_rewards(ts_code='600348.SH,600350.SH,600351.SH,600352.SH,600353.SH,600354.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_472 返回数据 row 行数 = "+str(stk_rewards_item_472.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_473 = pro.stk_rewards(ts_code='600355.SH,600356.SH,600357.SH,600358.SH,600359.SH,600360.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_473 返回数据 row 行数 = "+str(stk_rewards_item_473.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_474 = pro.stk_rewards(ts_code='600361.SH,600362.SH,600363.SH,600365.SH,600366.SH,600367.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_474 返回数据 row 行数 = "+str(stk_rewards_item_474.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_475 = pro.stk_rewards(ts_code='600368.SH,600369.SH,600370.SH,600371.SH,600372.SH,600373.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_475 返回数据 row 行数 = "+str(stk_rewards_item_475.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_476 = pro.stk_rewards(ts_code='600375.SH,600376.SH,600377.SH,600378.SH,600379.SH,600380.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_476 返回数据 row 行数 = "+str(stk_rewards_item_476.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_477 = pro.stk_rewards(ts_code='600381.SH,600382.SH,600383.SH,600385.SH,600386.SH,600387.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_477 返回数据 row 行数 = "+str(stk_rewards_item_477.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_478 = pro.stk_rewards(ts_code='600388.SH,600389.SH,600390.SH,600391.SH,600392.SH,600393.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_478 返回数据 row 行数 = "+str(stk_rewards_item_478.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_479 = pro.stk_rewards(ts_code='600395.SH,600396.SH,600397.SH,600398.SH,600399.SH,600400.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_479 返回数据 row 行数 = "+str(stk_rewards_item_479.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_480 = pro.stk_rewards(ts_code='600401.SH,600403.SH,600405.SH,600406.SH,600408.SH,600409.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_480 返回数据 row 行数 = "+str(stk_rewards_item_480.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_481 = pro.stk_rewards(ts_code='600410.SH,600415.SH,600416.SH,600418.SH,600419.SH,600420.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_481 返回数据 row 行数 = "+str(stk_rewards_item_481.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_482 = pro.stk_rewards(ts_code='600421.SH,600422.SH,600423.SH,600425.SH,600426.SH,600428.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_482 返回数据 row 行数 = "+str(stk_rewards_item_482.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_483 = pro.stk_rewards(ts_code='600429.SH,600432.SH,600433.SH,600435.SH,600436.SH,600438.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_483 返回数据 row 行数 = "+str(stk_rewards_item_483.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_484 = pro.stk_rewards(ts_code='600439.SH,600444.SH,600446.SH,600448.SH,600449.SH,600452.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_484 返回数据 row 行数 = "+str(stk_rewards_item_484.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_485 = pro.stk_rewards(ts_code='600455.SH,600456.SH,600458.SH,600459.SH,600460.SH,600461.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_485 返回数据 row 行数 = "+str(stk_rewards_item_485.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_486 = pro.stk_rewards(ts_code='600462.SH,600463.SH,600466.SH,600467.SH,600468.SH,600469.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_486 返回数据 row 行数 = "+str(stk_rewards_item_486.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_487 = pro.stk_rewards(ts_code='600470.SH,600472.SH,600475.SH,600476.SH,600477.SH,600478.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_487 返回数据 row 行数 = "+str(stk_rewards_item_487.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_488 = pro.stk_rewards(ts_code='600479.SH,600480.SH,600481.SH,600482.SH,600483.SH,600485.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_488 返回数据 row 行数 = "+str(stk_rewards_item_488.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_489 = pro.stk_rewards(ts_code='600486.SH,600487.SH,600488.SH,600489.SH,600490.SH,600491.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_489 返回数据 row 行数 = "+str(stk_rewards_item_489.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_490 = pro.stk_rewards(ts_code='600493.SH,600495.SH,600496.SH,600497.SH,600498.SH,600499.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_490 返回数据 row 行数 = "+str(stk_rewards_item_490.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_491 = pro.stk_rewards(ts_code='600500.SH,600501.SH,600502.SH,600503.SH,600505.SH,600506.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_491 返回数据 row 行数 = "+str(stk_rewards_item_491.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_492 = pro.stk_rewards(ts_code='600507.SH,600508.SH,600509.SH,600510.SH,600511.SH,600512.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_492 返回数据 row 行数 = "+str(stk_rewards_item_492.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_493 = pro.stk_rewards(ts_code='600513.SH,600515.SH,600516.SH,600517.SH,600518.SH,600519.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_493 返回数据 row 行数 = "+str(stk_rewards_item_493.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_494 = pro.stk_rewards(ts_code='600520.SH,600521.SH,600522.SH,600523.SH,600525.SH,600526.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_494 返回数据 row 行数 = "+str(stk_rewards_item_494.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_495 = pro.stk_rewards(ts_code='600527.SH,600528.SH,600529.SH,600530.SH,600531.SH,600532.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_495 返回数据 row 行数 = "+str(stk_rewards_item_495.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_496 = pro.stk_rewards(ts_code='600533.SH,600535.SH,600536.SH,600537.SH,600538.SH,600539.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_496 返回数据 row 行数 = "+str(stk_rewards_item_496.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_497 = pro.stk_rewards(ts_code='600540.SH,600543.SH,600545.SH,600546.SH,600547.SH,600548.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_497 返回数据 row 行数 = "+str(stk_rewards_item_497.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_498 = pro.stk_rewards(ts_code='600549.SH,600550.SH,600551.SH,600552.SH,600553.SH,600555.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_498 返回数据 row 行数 = "+str(stk_rewards_item_498.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_499 = pro.stk_rewards(ts_code='600556.SH,600557.SH,600558.SH,600559.SH,600560.SH,600561.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_499 返回数据 row 行数 = "+str(stk_rewards_item_499.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_500 = pro.stk_rewards(ts_code='600562.SH,600563.SH,600565.SH,600566.SH,600567.SH,600568.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_500 返回数据 row 行数 = "+str(stk_rewards_item_500.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_501 = pro.stk_rewards(ts_code='600569.SH,600570.SH,600571.SH,600572.SH,600573.SH,600575.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_501 返回数据 row 行数 = "+str(stk_rewards_item_501.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_502 = pro.stk_rewards(ts_code='600576.SH,600577.SH,600578.SH,600579.SH,600580.SH,600581.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_502 返回数据 row 行数 = "+str(stk_rewards_item_502.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_503 = pro.stk_rewards(ts_code='600582.SH,600583.SH,600584.SH,600585.SH,600586.SH,600587.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_503 返回数据 row 行数 = "+str(stk_rewards_item_503.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_504 = pro.stk_rewards(ts_code='600588.SH,600589.SH,600590.SH,600591.SH,600592.SH,600593.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_504 返回数据 row 行数 = "+str(stk_rewards_item_504.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_505 = pro.stk_rewards(ts_code='600594.SH,600595.SH,600596.SH,600597.SH,600598.SH,600599.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_505 返回数据 row 行数 = "+str(stk_rewards_item_505.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_506 = pro.stk_rewards(ts_code='600600.SH,600601.SH,600602.SH,600603.SH,600604.SH,600605.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_506 返回数据 row 行数 = "+str(stk_rewards_item_506.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_507 = pro.stk_rewards(ts_code='600606.SH,600607.SH,600608.SH,600609.SH,600610.SH,600611.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_507 返回数据 row 行数 = "+str(stk_rewards_item_507.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_508 = pro.stk_rewards(ts_code='600612.SH,600613.SH,600614.SH,600615.SH,600616.SH,600617.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_508 返回数据 row 行数 = "+str(stk_rewards_item_508.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_509 = pro.stk_rewards(ts_code='600618.SH,600619.SH,600620.SH,600621.SH,600622.SH,600623.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_509 返回数据 row 行数 = "+str(stk_rewards_item_509.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_510 = pro.stk_rewards(ts_code='600624.SH,600625.SH,600626.SH,600627.SH,600628.SH,600629.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_510 返回数据 row 行数 = "+str(stk_rewards_item_510.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_511 = pro.stk_rewards(ts_code='600630.SH,600631.SH,600632.SH,600633.SH,600634.SH,600635.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_511 返回数据 row 行数 = "+str(stk_rewards_item_511.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_512 = pro.stk_rewards(ts_code='600636.SH,600637.SH,600638.SH,600639.SH,600640.SH,600641.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_512 返回数据 row 行数 = "+str(stk_rewards_item_512.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_513 = pro.stk_rewards(ts_code='600642.SH,600643.SH,600644.SH,600645.SH,600646.SH,600647.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_513 返回数据 row 行数 = "+str(stk_rewards_item_513.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_514 = pro.stk_rewards(ts_code='600648.SH,600649.SH,600650.SH,600651.SH,600652.SH,600653.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_514 返回数据 row 行数 = "+str(stk_rewards_item_514.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_515 = pro.stk_rewards(ts_code='600654.SH,600655.SH,600656.SH,600657.SH,600658.SH,600659.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_515 返回数据 row 行数 = "+str(stk_rewards_item_515.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_516 = pro.stk_rewards(ts_code='600660.SH,600661.SH,600662.SH,600663.SH,600664.SH,600665.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_516 返回数据 row 行数 = "+str(stk_rewards_item_516.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_517 = pro.stk_rewards(ts_code='600666.SH,600667.SH,600668.SH,600669.SH,600670.SH,600671.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_517 返回数据 row 行数 = "+str(stk_rewards_item_517.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_518 = pro.stk_rewards(ts_code='600672.SH,600673.SH,600674.SH,600675.SH,600676.SH,600677.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_518 返回数据 row 行数 = "+str(stk_rewards_item_518.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_519 = pro.stk_rewards(ts_code='600678.SH,600679.SH,600680.SH,600681.SH,600682.SH,600683.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_519 返回数据 row 行数 = "+str(stk_rewards_item_519.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_520 = pro.stk_rewards(ts_code='600684.SH,600685.SH,600686.SH,600687.SH,600688.SH,600689.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_520 返回数据 row 行数 = "+str(stk_rewards_item_520.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_521 = pro.stk_rewards(ts_code='600690.SH,600691.SH,600692.SH,600693.SH,600694.SH,600695.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_521 返回数据 row 行数 = "+str(stk_rewards_item_521.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_522 = pro.stk_rewards(ts_code='600696.SH,600697.SH,600698.SH,600699.SH,600700.SH,600701.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_522 返回数据 row 行数 = "+str(stk_rewards_item_522.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_523 = pro.stk_rewards(ts_code='600702.SH,600703.SH,600704.SH,600705.SH,600706.SH,600707.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_523 返回数据 row 行数 = "+str(stk_rewards_item_523.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_524 = pro.stk_rewards(ts_code='600708.SH,600709.SH,600710.SH,600711.SH,600712.SH,600713.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_524 返回数据 row 行数 = "+str(stk_rewards_item_524.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_525 = pro.stk_rewards(ts_code='600714.SH,600715.SH,600716.SH,600717.SH,600718.SH,600719.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_525 返回数据 row 行数 = "+str(stk_rewards_item_525.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_526 = pro.stk_rewards(ts_code='600720.SH,600721.SH,600722.SH,600723.SH,600724.SH,600725.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_526 返回数据 row 行数 = "+str(stk_rewards_item_526.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_527 = pro.stk_rewards(ts_code='600726.SH,600727.SH,600728.SH,600729.SH,600730.SH,600731.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_527 返回数据 row 行数 = "+str(stk_rewards_item_527.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_528 = pro.stk_rewards(ts_code='600732.SH,600733.SH,600734.SH,600735.SH,600736.SH,600737.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_528 返回数据 row 行数 = "+str(stk_rewards_item_528.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_529 = pro.stk_rewards(ts_code='600738.SH,600739.SH,600740.SH,600741.SH,600742.SH,600743.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_529 返回数据 row 行数 = "+str(stk_rewards_item_529.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_530 = pro.stk_rewards(ts_code='600744.SH,600745.SH,600746.SH,600747.SH,600748.SH,600749.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_530 返回数据 row 行数 = "+str(stk_rewards_item_530.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_531 = pro.stk_rewards(ts_code='600750.SH,600751.SH,600752.SH,600753.SH,600754.SH,600755.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_531 返回数据 row 行数 = "+str(stk_rewards_item_531.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_532 = pro.stk_rewards(ts_code='600756.SH,600757.SH,600758.SH,600759.SH,600760.SH,600761.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_532 返回数据 row 行数 = "+str(stk_rewards_item_532.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_533 = pro.stk_rewards(ts_code='600762.SH,600763.SH,600764.SH,600765.SH,600766.SH,600767.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_533 返回数据 row 行数 = "+str(stk_rewards_item_533.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_534 = pro.stk_rewards(ts_code='600768.SH,600769.SH,600770.SH,600771.SH,600772.SH,600773.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_534 返回数据 row 行数 = "+str(stk_rewards_item_534.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_535 = pro.stk_rewards(ts_code='600774.SH,600775.SH,600776.SH,600777.SH,600778.SH,600779.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_535 返回数据 row 行数 = "+str(stk_rewards_item_535.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_536 = pro.stk_rewards(ts_code='600780.SH,600781.SH,600782.SH,600783.SH,600784.SH,600785.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_536 返回数据 row 行数 = "+str(stk_rewards_item_536.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_537 = pro.stk_rewards(ts_code='600786.SH,600787.SH,600788.SH,600789.SH,600790.SH,600791.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_537 返回数据 row 行数 = "+str(stk_rewards_item_537.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_538 = pro.stk_rewards(ts_code='600792.SH,600793.SH,600794.SH,600795.SH,600796.SH,600797.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_538 返回数据 row 行数 = "+str(stk_rewards_item_538.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_539 = pro.stk_rewards(ts_code='600798.SH,600799.SH,600800.SH,600801.SH,600802.SH,600803.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_539 返回数据 row 行数 = "+str(stk_rewards_item_539.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_540 = pro.stk_rewards(ts_code='600804.SH,600805.SH,600806.SH,600807.SH,600808.SH,600809.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_540 返回数据 row 行数 = "+str(stk_rewards_item_540.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_541 = pro.stk_rewards(ts_code='600810.SH,600811.SH,600812.SH,600813.SH,600814.SH,600815.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_541 返回数据 row 行数 = "+str(stk_rewards_item_541.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_542 = pro.stk_rewards(ts_code='600816.SH,600817.SH,600818.SH,600819.SH,600820.SH,600821.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_542 返回数据 row 行数 = "+str(stk_rewards_item_542.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_543 = pro.stk_rewards(ts_code='600822.SH,600823.SH,600824.SH,600825.SH,600826.SH,600827.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_543 返回数据 row 行数 = "+str(stk_rewards_item_543.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_544 = pro.stk_rewards(ts_code='600828.SH,600829.SH,600830.SH,600831.SH,600832.SH,600833.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_544 返回数据 row 行数 = "+str(stk_rewards_item_544.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_545 = pro.stk_rewards(ts_code='600834.SH,600835.SH,600836.SH,600837.SH,600838.SH,600839.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_545 返回数据 row 行数 = "+str(stk_rewards_item_545.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_546 = pro.stk_rewards(ts_code='600840.SH,600841.SH,600842.SH,600843.SH,600844.SH,600845.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_546 返回数据 row 行数 = "+str(stk_rewards_item_546.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_547 = pro.stk_rewards(ts_code='600846.SH,600847.SH,600848.SH,600850.SH,600851.SH,600852.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_547 返回数据 row 行数 = "+str(stk_rewards_item_547.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_548 = pro.stk_rewards(ts_code='600853.SH,600854.SH,600855.SH,600856.SH,600857.SH,600858.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_548 返回数据 row 行数 = "+str(stk_rewards_item_548.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_549 = pro.stk_rewards(ts_code='600859.SH,600860.SH,600861.SH,600862.SH,600863.SH,600864.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_549 返回数据 row 行数 = "+str(stk_rewards_item_549.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_550 = pro.stk_rewards(ts_code='600865.SH,600866.SH,600867.SH,600868.SH,600869.SH,600870.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_550 返回数据 row 行数 = "+str(stk_rewards_item_550.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_551 = pro.stk_rewards(ts_code='600871.SH,600872.SH,600873.SH,600874.SH,600875.SH,600876.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_551 返回数据 row 行数 = "+str(stk_rewards_item_551.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_552 = pro.stk_rewards(ts_code='600877.SH,600878.SH,600879.SH,600880.SH,600881.SH,600882.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_552 返回数据 row 行数 = "+str(stk_rewards_item_552.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_553 = pro.stk_rewards(ts_code='600883.SH,600884.SH,600885.SH,600886.SH,600887.SH,600888.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_553 返回数据 row 行数 = "+str(stk_rewards_item_553.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_554 = pro.stk_rewards(ts_code='600889.SH,600890.SH,600891.SH,600892.SH,600893.SH,600894.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_554 返回数据 row 行数 = "+str(stk_rewards_item_554.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_555 = pro.stk_rewards(ts_code='600895.SH,600896.SH,600897.SH,600898.SH,600899.SH,600900.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_555 返回数据 row 行数 = "+str(stk_rewards_item_555.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_556 = pro.stk_rewards(ts_code='600901.SH,600903.SH,600905.SH,600906.SH,600908.SH,600909.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_556 返回数据 row 行数 = "+str(stk_rewards_item_556.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_557 = pro.stk_rewards(ts_code='600916.SH,600917.SH,600918.SH,600919.SH,600926.SH,600928.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_557 返回数据 row 行数 = "+str(stk_rewards_item_557.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_558 = pro.stk_rewards(ts_code='600929.SH,600933.SH,600936.SH,600939.SH,600956.SH,600958.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_558 返回数据 row 行数 = "+str(stk_rewards_item_558.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_559 = pro.stk_rewards(ts_code='600959.SH,600960.SH,600961.SH,600962.SH,600963.SH,600965.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_559 返回数据 row 行数 = "+str(stk_rewards_item_559.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_560 = pro.stk_rewards(ts_code='600966.SH,600967.SH,600968.SH,600969.SH,600970.SH,600971.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_560 返回数据 row 行数 = "+str(stk_rewards_item_560.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_561 = pro.stk_rewards(ts_code='600973.SH,600975.SH,600976.SH,600977.SH,600978.SH,600979.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_561 返回数据 row 行数 = "+str(stk_rewards_item_561.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_562 = pro.stk_rewards(ts_code='600980.SH,600981.SH,600982.SH,600983.SH,600984.SH,600985.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_562 返回数据 row 行数 = "+str(stk_rewards_item_562.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_563 = pro.stk_rewards(ts_code='600986.SH,600987.SH,600988.SH,600989.SH,600990.SH,600991.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_563 返回数据 row 行数 = "+str(stk_rewards_item_563.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_564 = pro.stk_rewards(ts_code='600992.SH,600993.SH,600995.SH,600996.SH,600997.SH,600998.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_564 返回数据 row 行数 = "+str(stk_rewards_item_564.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_565 = pro.stk_rewards(ts_code='600999.SH,601000.SH,601001.SH,601002.SH,601003.SH,601005.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_565 返回数据 row 行数 = "+str(stk_rewards_item_565.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_566 = pro.stk_rewards(ts_code='601006.SH,601007.SH,601008.SH,601009.SH,601010.SH,601011.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_566 返回数据 row 行数 = "+str(stk_rewards_item_566.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_567 = pro.stk_rewards(ts_code='601012.SH,601015.SH,601016.SH,601018.SH,601019.SH,601020.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_567 返回数据 row 行数 = "+str(stk_rewards_item_567.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_568 = pro.stk_rewards(ts_code='601021.SH,601028.SH,601038.SH,601058.SH,601066.SH,601068.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_568 返回数据 row 行数 = "+str(stk_rewards_item_568.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_569 = pro.stk_rewards(ts_code='601069.SH,601077.SH,601086.SH,601088.SH,601098.SH,601099.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_569 返回数据 row 行数 = "+str(stk_rewards_item_569.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_570 = pro.stk_rewards(ts_code='601100.SH,601101.SH,601106.SH,601107.SH,601108.SH,601111.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_570 返回数据 row 行数 = "+str(stk_rewards_item_570.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_571 = pro.stk_rewards(ts_code='601113.SH,601116.SH,601117.SH,601118.SH,601126.SH,601127.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_571 返回数据 row 行数 = "+str(stk_rewards_item_571.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_572 = pro.stk_rewards(ts_code='601128.SH,601137.SH,601138.SH,601139.SH,601155.SH,601156.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_572 返回数据 row 行数 = "+str(stk_rewards_item_572.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_573 = pro.stk_rewards(ts_code='601158.SH,601162.SH,601163.SH,601166.SH,601168.SH,601169.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_573 返回数据 row 行数 = "+str(stk_rewards_item_573.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_574 = pro.stk_rewards(ts_code='601177.SH,601179.SH,601186.SH,601187.SH,601188.SH,601198.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_574 返回数据 row 行数 = "+str(stk_rewards_item_574.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_575 = pro.stk_rewards(ts_code='601199.SH,601200.SH,601208.SH,601211.SH,601212.SH,601216.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_575 返回数据 row 行数 = "+str(stk_rewards_item_575.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_576 = pro.stk_rewards(ts_code='601218.SH,601222.SH,601225.SH,601226.SH,601228.SH,601229.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_576 返回数据 row 行数 = "+str(stk_rewards_item_576.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_577 = pro.stk_rewards(ts_code='601231.SH,601233.SH,601236.SH,601238.SH,601258.SH,601268.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_577 返回数据 row 行数 = "+str(stk_rewards_item_577.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_578 = pro.stk_rewards(ts_code='601279.SH,601288.SH,601298.SH,601299.SH,601311.SH,601318.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_578 返回数据 row 行数 = "+str(stk_rewards_item_578.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_579 = pro.stk_rewards(ts_code='601319.SH,601326.SH,601328.SH,601330.SH,601333.SH,601336.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_579 返回数据 row 行数 = "+str(stk_rewards_item_579.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_580 = pro.stk_rewards(ts_code='601339.SH,601360.SH,601366.SH,601368.SH,601369.SH,601375.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_580 返回数据 row 行数 = "+str(stk_rewards_item_580.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_581 = pro.stk_rewards(ts_code='601377.SH,601388.SH,601390.SH,601398.SH,601399.SH,601456.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_581 返回数据 row 行数 = "+str(stk_rewards_item_581.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_582 = pro.stk_rewards(ts_code='601500.SH,601512.SH,601515.SH,601518.SH,601519.SH,601528.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_582 返回数据 row 行数 = "+str(stk_rewards_item_582.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_583 = pro.stk_rewards(ts_code='601555.SH,601558.SH,601566.SH,601567.SH,601568.SH,601577.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_583 返回数据 row 行数 = "+str(stk_rewards_item_583.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_584 = pro.stk_rewards(ts_code='601579.SH,601588.SH,601595.SH,601598.SH,601599.SH,601600.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_584 返回数据 row 行数 = "+str(stk_rewards_item_584.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_585 = pro.stk_rewards(ts_code='601601.SH,601606.SH,601607.SH,601608.SH,601609.SH,601611.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_585 返回数据 row 行数 = "+str(stk_rewards_item_585.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_586 = pro.stk_rewards(ts_code='601615.SH,601616.SH,601618.SH,601619.SH,601628.SH,601633.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_586 返回数据 row 行数 = "+str(stk_rewards_item_586.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_587 = pro.stk_rewards(ts_code='601636.SH,601658.SH,601665.SH,601666.SH,601668.SH,601669.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_587 返回数据 row 行数 = "+str(stk_rewards_item_587.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_588 = pro.stk_rewards(ts_code='601677.SH,601678.SH,601686.SH,601688.SH,601689.SH,601696.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_588 返回数据 row 行数 = "+str(stk_rewards_item_588.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_589 = pro.stk_rewards(ts_code='601698.SH,601699.SH,601700.SH,601702.SH,601717.SH,601718.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_589 返回数据 row 行数 = "+str(stk_rewards_item_589.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_590 = pro.stk_rewards(ts_code='601727.SH,601766.SH,601777.SH,601778.SH,601788.SH,601789.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_590 返回数据 row 行数 = "+str(stk_rewards_item_590.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_591 = pro.stk_rewards(ts_code='601798.SH,601799.SH,601800.SH,601801.SH,601808.SH,601811.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_591 返回数据 row 行数 = "+str(stk_rewards_item_591.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_592 = pro.stk_rewards(ts_code='601816.SH,601818.SH,601827.SH,601828.SH,601838.SH,601857.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_592 返回数据 row 行数 = "+str(stk_rewards_item_592.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_593 = pro.stk_rewards(ts_code='601858.SH,601860.SH,601865.SH,601866.SH,601869.SH,601872.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_593 返回数据 row 行数 = "+str(stk_rewards_item_593.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_594 = pro.stk_rewards(ts_code='601877.SH,601878.SH,601880.SH,601881.SH,601882.SH,601886.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_594 返回数据 row 行数 = "+str(stk_rewards_item_594.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_595 = pro.stk_rewards(ts_code='601888.SH,601890.SH,601898.SH,601899.SH,601900.SH,601901.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_595 返回数据 row 行数 = "+str(stk_rewards_item_595.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_596 = pro.stk_rewards(ts_code='601908.SH,601916.SH,601918.SH,601919.SH,601928.SH,601929.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_596 返回数据 row 行数 = "+str(stk_rewards_item_596.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_597 = pro.stk_rewards(ts_code='601933.SH,601939.SH,601949.SH,601952.SH,601956.SH,601958.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_597 返回数据 row 行数 = "+str(stk_rewards_item_597.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_598 = pro.stk_rewards(ts_code='601963.SH,601965.SH,601966.SH,601968.SH,601969.SH,601975.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_598 返回数据 row 行数 = "+str(stk_rewards_item_598.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_599 = pro.stk_rewards(ts_code='601985.SH,601988.SH,601989.SH,601990.SH,601991.SH,601992.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_599 返回数据 row 行数 = "+str(stk_rewards_item_599.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_600 = pro.stk_rewards(ts_code='601995.SH,601996.SH,601997.SH,601998.SH,601999.SH,603000.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_600 返回数据 row 行数 = "+str(stk_rewards_item_600.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_601 = pro.stk_rewards(ts_code='603001.SH,603002.SH,603003.SH,603005.SH,603006.SH,603007.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_601 返回数据 row 行数 = "+str(stk_rewards_item_601.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_602 = pro.stk_rewards(ts_code='603008.SH,603009.SH,603010.SH,603011.SH,603012.SH,603013.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_602 返回数据 row 行数 = "+str(stk_rewards_item_602.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_603 = pro.stk_rewards(ts_code='603015.SH,603016.SH,603017.SH,603018.SH,603019.SH,603020.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_603 返回数据 row 行数 = "+str(stk_rewards_item_603.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_604 = pro.stk_rewards(ts_code='603021.SH,603022.SH,603023.SH,603025.SH,603026.SH,603027.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_604 返回数据 row 行数 = "+str(stk_rewards_item_604.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_605 = pro.stk_rewards(ts_code='603028.SH,603029.SH,603030.SH,603031.SH,603032.SH,603033.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_605 返回数据 row 行数 = "+str(stk_rewards_item_605.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_606 = pro.stk_rewards(ts_code='603035.SH,603036.SH,603037.SH,603038.SH,603039.SH,603040.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_606 返回数据 row 行数 = "+str(stk_rewards_item_606.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_607 = pro.stk_rewards(ts_code='603041.SH,603042.SH,603043.SH,603045.SH,603050.SH,603053.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_607 返回数据 row 行数 = "+str(stk_rewards_item_607.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_608 = pro.stk_rewards(ts_code='603055.SH,603056.SH,603058.SH,603059.SH,603060.SH,603063.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_608 返回数据 row 行数 = "+str(stk_rewards_item_608.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_609 = pro.stk_rewards(ts_code='603066.SH,603067.SH,603068.SH,603069.SH,603076.SH,603077.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_609 返回数据 row 行数 = "+str(stk_rewards_item_609.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_610 = pro.stk_rewards(ts_code='603078.SH,603079.SH,603080.SH,603081.SH,603083.SH,603085.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_610 返回数据 row 行数 = "+str(stk_rewards_item_610.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_611 = pro.stk_rewards(ts_code='603086.SH,603087.SH,603088.SH,603089.SH,603090.SH,603093.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_611 返回数据 row 行数 = "+str(stk_rewards_item_611.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_612 = pro.stk_rewards(ts_code='603095.SH,603096.SH,603098.SH,603099.SH,603100.SH,603101.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_612 返回数据 row 行数 = "+str(stk_rewards_item_612.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_613 = pro.stk_rewards(ts_code='603103.SH,603105.SH,603106.SH,603108.SH,603109.SH,603110.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_613 返回数据 row 行数 = "+str(stk_rewards_item_613.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_614 = pro.stk_rewards(ts_code='603111.SH,603112.SH,603113.SH,603115.SH,603116.SH,603117.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_614 返回数据 row 行数 = "+str(stk_rewards_item_614.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_615 = pro.stk_rewards(ts_code='603118.SH,603121.SH,603123.SH,603126.SH,603127.SH,603128.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_615 返回数据 row 行数 = "+str(stk_rewards_item_615.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_616 = pro.stk_rewards(ts_code='603129.SH,603131.SH,603133.SH,603136.SH,603138.SH,603139.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_616 返回数据 row 行数 = "+str(stk_rewards_item_616.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_617 = pro.stk_rewards(ts_code='603155.SH,603156.SH,603157.SH,603158.SH,603159.SH,603160.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_617 返回数据 row 行数 = "+str(stk_rewards_item_617.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_618 = pro.stk_rewards(ts_code='603161.SH,603165.SH,603166.SH,603167.SH,603168.SH,603169.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_618 返回数据 row 行数 = "+str(stk_rewards_item_618.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_619 = pro.stk_rewards(ts_code='603171.SH,603177.SH,603178.SH,603179.SH,603180.SH,603181.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_619 返回数据 row 行数 = "+str(stk_rewards_item_619.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_620 = pro.stk_rewards(ts_code='603183.SH,603185.SH,603186.SH,603187.SH,603188.SH,603189.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_620 返回数据 row 行数 = "+str(stk_rewards_item_620.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_621 = pro.stk_rewards(ts_code='603192.SH,603195.SH,603196.SH,603197.SH,603198.SH,603199.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_621 返回数据 row 行数 = "+str(stk_rewards_item_621.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_622 = pro.stk_rewards(ts_code='603200.SH,603203.SH,603208.SH,603212.SH,603214.SH,603217.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_622 返回数据 row 行数 = "+str(stk_rewards_item_622.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_623 = pro.stk_rewards(ts_code='603218.SH,603220.SH,603221.SH,603222.SH,603223.SH,603225.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_623 返回数据 row 行数 = "+str(stk_rewards_item_623.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_624 = pro.stk_rewards(ts_code='603226.SH,603227.SH,603228.SH,603229.SH,603232.SH,603233.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_624 返回数据 row 行数 = "+str(stk_rewards_item_624.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_625 = pro.stk_rewards(ts_code='603236.SH,603238.SH,603239.SH,603256.SH,603258.SH,603259.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_625 返回数据 row 行数 = "+str(stk_rewards_item_625.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_626 = pro.stk_rewards(ts_code='603260.SH,603266.SH,603267.SH,603268.SH,603269.SH,603277.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_626 返回数据 row 行数 = "+str(stk_rewards_item_626.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_627 = pro.stk_rewards(ts_code='603278.SH,603279.SH,603283.SH,603286.SH,603288.SH,603289.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_627 返回数据 row 行数 = "+str(stk_rewards_item_627.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_628 = pro.stk_rewards(ts_code='603290.SH,603297.SH,603298.SH,603299.SH,603300.SH,603301.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_628 返回数据 row 行数 = "+str(stk_rewards_item_628.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_629 = pro.stk_rewards(ts_code='603303.SH,603305.SH,603306.SH,603308.SH,603309.SH,603311.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_629 返回数据 row 行数 = "+str(stk_rewards_item_629.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_630 = pro.stk_rewards(ts_code='603313.SH,603315.SH,603316.SH,603317.SH,603318.SH,603319.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_630 返回数据 row 行数 = "+str(stk_rewards_item_630.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_631 = pro.stk_rewards(ts_code='603320.SH,603321.SH,603322.SH,603323.SH,603324.SH,603326.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_631 返回数据 row 行数 = "+str(stk_rewards_item_631.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_632 = pro.stk_rewards(ts_code='603327.SH,603328.SH,603329.SH,603330.SH,603331.SH,603332.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_632 返回数据 row 行数 = "+str(stk_rewards_item_632.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_633 = pro.stk_rewards(ts_code='603333.SH,603335.SH,603336.SH,603337.SH,603338.SH,603339.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_633 返回数据 row 行数 = "+str(stk_rewards_item_633.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_634 = pro.stk_rewards(ts_code='603345.SH,603348.SH,603351.SH,603353.SH,603355.SH,603356.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_634 返回数据 row 行数 = "+str(stk_rewards_item_634.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_635 = pro.stk_rewards(ts_code='603357.SH,603358.SH,603359.SH,603360.SH,603363.SH,603365.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_635 返回数据 row 行数 = "+str(stk_rewards_item_635.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_636 = pro.stk_rewards(ts_code='603366.SH,603367.SH,603368.SH,603369.SH,603377.SH,603378.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_636 返回数据 row 行数 = "+str(stk_rewards_item_636.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_637 = pro.stk_rewards(ts_code='603379.SH,603380.SH,603383.SH,603385.SH,603386.SH,603387.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_637 返回数据 row 行数 = "+str(stk_rewards_item_637.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_638 = pro.stk_rewards(ts_code='603388.SH,603389.SH,603390.SH,603392.SH,603393.SH,603396.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_638 返回数据 row 行数 = "+str(stk_rewards_item_638.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_639 = pro.stk_rewards(ts_code='603398.SH,603399.SH,603408.SH,603416.SH,603421.SH,603429.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_639 返回数据 row 行数 = "+str(stk_rewards_item_639.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_640 = pro.stk_rewards(ts_code='603439.SH,603444.SH,603456.SH,603458.SH,603466.SH,603477.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_640 返回数据 row 行数 = "+str(stk_rewards_item_640.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_641 = pro.stk_rewards(ts_code='603486.SH,603488.SH,603489.SH,603496.SH,603499.SH,603500.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_641 返回数据 row 行数 = "+str(stk_rewards_item_641.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_642 = pro.stk_rewards(ts_code='603501.SH,603505.SH,603506.SH,603507.SH,603508.SH,603511.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_642 返回数据 row 行数 = "+str(stk_rewards_item_642.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_643 = pro.stk_rewards(ts_code='603515.SH,603516.SH,603517.SH,603518.SH,603519.SH,603520.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_643 返回数据 row 行数 = "+str(stk_rewards_item_643.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_644 = pro.stk_rewards(ts_code='603527.SH,603528.SH,603529.SH,603530.SH,603533.SH,603535.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_644 返回数据 row 行数 = "+str(stk_rewards_item_644.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_645 = pro.stk_rewards(ts_code='603536.SH,603538.SH,603551.SH,603555.SH,603556.SH,603557.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_645 返回数据 row 行数 = "+str(stk_rewards_item_645.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_646 = pro.stk_rewards(ts_code='603558.SH,603559.SH,603565.SH,603566.SH,603567.SH,603568.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_646 返回数据 row 行数 = "+str(stk_rewards_item_646.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_647 = pro.stk_rewards(ts_code='603569.SH,603577.SH,603578.SH,603579.SH,603580.SH,603583.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_647 返回数据 row 行数 = "+str(stk_rewards_item_647.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_648 = pro.stk_rewards(ts_code='603585.SH,603586.SH,603587.SH,603588.SH,603589.SH,603590.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_648 返回数据 row 行数 = "+str(stk_rewards_item_648.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_649 = pro.stk_rewards(ts_code='603595.SH,603596.SH,603598.SH,603599.SH,603600.SH,603601.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_649 返回数据 row 行数 = "+str(stk_rewards_item_649.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_650 = pro.stk_rewards(ts_code='603602.SH,603603.SH,603605.SH,603606.SH,603607.SH,603608.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_650 返回数据 row 行数 = "+str(stk_rewards_item_650.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_651 = pro.stk_rewards(ts_code='603609.SH,603610.SH,603611.SH,603612.SH,603613.SH,603615.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_651 返回数据 row 行数 = "+str(stk_rewards_item_651.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_652 = pro.stk_rewards(ts_code='603616.SH,603617.SH,603618.SH,603619.SH,603626.SH,603628.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_652 返回数据 row 行数 = "+str(stk_rewards_item_652.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_653 = pro.stk_rewards(ts_code='603629.SH,603630.SH,603633.SH,603636.SH,603637.SH,603638.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_653 返回数据 row 行数 = "+str(stk_rewards_item_653.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_654 = pro.stk_rewards(ts_code='603639.SH,603648.SH,603650.SH,603655.SH,603656.SH,603657.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_654 返回数据 row 行数 = "+str(stk_rewards_item_654.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_655 = pro.stk_rewards(ts_code='603658.SH,603659.SH,603660.SH,603661.SH,603662.SH,603663.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_655 返回数据 row 行数 = "+str(stk_rewards_item_655.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_656 = pro.stk_rewards(ts_code='603665.SH,603666.SH,603667.SH,603668.SH,603669.SH,603676.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_656 返回数据 row 行数 = "+str(stk_rewards_item_656.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_657 = pro.stk_rewards(ts_code='603677.SH,603678.SH,603679.SH,603680.SH,603681.SH,603682.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_657 返回数据 row 行数 = "+str(stk_rewards_item_657.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_658 = pro.stk_rewards(ts_code='603683.SH,603685.SH,603686.SH,603687.SH,603688.SH,603689.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_658 返回数据 row 行数 = "+str(stk_rewards_item_658.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_659 = pro.stk_rewards(ts_code='603690.SH,603693.SH,603696.SH,603697.SH,603698.SH,603699.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_659 返回数据 row 行数 = "+str(stk_rewards_item_659.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_660 = pro.stk_rewards(ts_code='603700.SH,603701.SH,603703.SH,603706.SH,603707.SH,603708.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_660 返回数据 row 行数 = "+str(stk_rewards_item_660.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_661 = pro.stk_rewards(ts_code='603709.SH,603711.SH,603712.SH,603713.SH,603716.SH,603717.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_661 返回数据 row 行数 = "+str(stk_rewards_item_661.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_662 = pro.stk_rewards(ts_code='603718.SH,603719.SH,603721.SH,603722.SH,603725.SH,603726.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_662 返回数据 row 行数 = "+str(stk_rewards_item_662.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_663 = pro.stk_rewards(ts_code='603727.SH,603728.SH,603729.SH,603730.SH,603733.SH,603737.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_663 返回数据 row 行数 = "+str(stk_rewards_item_663.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_664 = pro.stk_rewards(ts_code='603738.SH,603739.SH,603755.SH,603757.SH,603758.SH,603759.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_664 返回数据 row 行数 = "+str(stk_rewards_item_664.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_665 = pro.stk_rewards(ts_code='603766.SH,603767.SH,603768.SH,603773.SH,603776.SH,603777.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_665 返回数据 row 行数 = "+str(stk_rewards_item_665.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_666 = pro.stk_rewards(ts_code='603778.SH,603779.SH,603786.SH,603787.SH,603788.SH,603789.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_666 返回数据 row 行数 = "+str(stk_rewards_item_666.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_667 = pro.stk_rewards(ts_code='603790.SH,603797.SH,603798.SH,603799.SH,603800.SH,603801.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_667 返回数据 row 行数 = "+str(stk_rewards_item_667.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_668 = pro.stk_rewards(ts_code='603803.SH,603806.SH,603808.SH,603809.SH,603810.SH,603811.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_668 返回数据 row 行数 = "+str(stk_rewards_item_668.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_669 = pro.stk_rewards(ts_code='603813.SH,603815.SH,603816.SH,603817.SH,603818.SH,603819.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_669 返回数据 row 行数 = "+str(stk_rewards_item_669.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_670 = pro.stk_rewards(ts_code='603822.SH,603823.SH,603825.SH,603826.SH,603828.SH,603829.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_670 返回数据 row 行数 = "+str(stk_rewards_item_670.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_671 = pro.stk_rewards(ts_code='603833.SH,603836.SH,603838.SH,603839.SH,603843.SH,603848.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_671 返回数据 row 行数 = "+str(stk_rewards_item_671.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_672 = pro.stk_rewards(ts_code='603855.SH,603856.SH,603858.SH,603859.SH,603860.SH,603861.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_672 返回数据 row 行数 = "+str(stk_rewards_item_672.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_673 = pro.stk_rewards(ts_code='603863.SH,603866.SH,603867.SH,603868.SH,603869.SH,603871.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_673 返回数据 row 行数 = "+str(stk_rewards_item_673.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_674 = pro.stk_rewards(ts_code='603876.SH,603877.SH,603878.SH,603879.SH,603880.SH,603881.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_674 返回数据 row 行数 = "+str(stk_rewards_item_674.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_675 = pro.stk_rewards(ts_code='603882.SH,603883.SH,603885.SH,603886.SH,603887.SH,603888.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_675 返回数据 row 行数 = "+str(stk_rewards_item_675.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_676 = pro.stk_rewards(ts_code='603889.SH,603890.SH,603893.SH,603895.SH,603896.SH,603897.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_676 返回数据 row 行数 = "+str(stk_rewards_item_676.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
...
stk_rewards_item_677_tscode_list = list() 
stk_rewards_item_677 = pro.stk_rewards(ts_code='603898.SH,603899.SH,603900.SH,603901.SH,603903.SH,603906.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_677 返回数据 row 行数 = "+str(stk_rewards_item_677.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_677['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_677_tscode_list.append(stock_name)
stk_rewards_item_677_addname_dataframe=pd.DataFrame()
stk_rewards_item_677_addname_dataframe['cname'] = stk_rewards_item_677_tscode_list
for table_name in stk_rewards_item_677.columns.values.tolist():
    stk_rewards_item_677_addname_dataframe[table_name] = stk_rewards_item_677[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_677_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_678_tscode_list = list() 
stk_rewards_item_678 = pro.stk_rewards(ts_code='603908.SH,603909.SH,603912.SH,603915.SH,603916.SH,603917.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_678 返回数据 row 行数 = "+str(stk_rewards_item_678.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_678['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_678_tscode_list.append(stock_name)
stk_rewards_item_678_addname_dataframe=pd.DataFrame()
stk_rewards_item_678_addname_dataframe['cname'] = stk_rewards_item_678_tscode_list
for table_name in stk_rewards_item_678.columns.values.tolist():
    stk_rewards_item_678_addname_dataframe[table_name] = stk_rewards_item_678[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_678_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_679_tscode_list = list() 
stk_rewards_item_679 = pro.stk_rewards(ts_code='603918.SH,603919.SH,603920.SH,603922.SH,603926.SH,603927.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_679 返回数据 row 行数 = "+str(stk_rewards_item_679.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_679['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_679_tscode_list.append(stock_name)
stk_rewards_item_679_addname_dataframe=pd.DataFrame()
stk_rewards_item_679_addname_dataframe['cname'] = stk_rewards_item_679_tscode_list
for table_name in stk_rewards_item_679.columns.values.tolist():
    stk_rewards_item_679_addname_dataframe[table_name] = stk_rewards_item_679[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_679_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_680_tscode_list = list() 
stk_rewards_item_680 = pro.stk_rewards(ts_code='603928.SH,603929.SH,603931.SH,603933.SH,603936.SH,603937.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_680 返回数据 row 行数 = "+str(stk_rewards_item_680.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_680['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_680_tscode_list.append(stock_name)
stk_rewards_item_680_addname_dataframe=pd.DataFrame()
stk_rewards_item_680_addname_dataframe['cname'] = stk_rewards_item_680_tscode_list
for table_name in stk_rewards_item_680.columns.values.tolist():
    stk_rewards_item_680_addname_dataframe[table_name] = stk_rewards_item_680[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_680_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_681_tscode_list = list() 
stk_rewards_item_681 = pro.stk_rewards(ts_code='603938.SH,603939.SH,603948.SH,603949.SH,603950.SH,603955.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_681 返回数据 row 行数 = "+str(stk_rewards_item_681.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_681['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_681_tscode_list.append(stock_name)
stk_rewards_item_681_addname_dataframe=pd.DataFrame()
stk_rewards_item_681_addname_dataframe['cname'] = stk_rewards_item_681_tscode_list
for table_name in stk_rewards_item_681.columns.values.tolist():
    stk_rewards_item_681_addname_dataframe[table_name] = stk_rewards_item_681[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_681_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_682_tscode_list = list() 
stk_rewards_item_682 = pro.stk_rewards(ts_code='603956.SH,603958.SH,603959.SH,603960.SH,603963.SH,603966.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_682 返回数据 row 行数 = "+str(stk_rewards_item_682.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_682['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_682_tscode_list.append(stock_name)
stk_rewards_item_682_addname_dataframe=pd.DataFrame()
stk_rewards_item_682_addname_dataframe['cname'] = stk_rewards_item_682_tscode_list
for table_name in stk_rewards_item_682.columns.values.tolist():
    stk_rewards_item_682_addname_dataframe[table_name] = stk_rewards_item_682[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_682_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_683_tscode_list = list() 
stk_rewards_item_683 = pro.stk_rewards(ts_code='603967.SH,603968.SH,603969.SH,603970.SH,603976.SH,603977.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_683 返回数据 row 行数 = "+str(stk_rewards_item_683.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_683['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_683_tscode_list.append(stock_name)
stk_rewards_item_683_addname_dataframe=pd.DataFrame()
stk_rewards_item_683_addname_dataframe['cname'] = stk_rewards_item_683_tscode_list
for table_name in stk_rewards_item_683.columns.values.tolist():
    stk_rewards_item_683_addname_dataframe[table_name] = stk_rewards_item_683[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_683_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_684_tscode_list = list() 
stk_rewards_item_684 = pro.stk_rewards(ts_code='603978.SH,603979.SH,603980.SH,603982.SH,603983.SH,603985.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_684 返回数据 row 行数 = "+str(stk_rewards_item_684.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_684['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_684_tscode_list.append(stock_name)
stk_rewards_item_684_addname_dataframe=pd.DataFrame()
stk_rewards_item_684_addname_dataframe['cname'] = stk_rewards_item_684_tscode_list
for table_name in stk_rewards_item_684.columns.values.tolist():
    stk_rewards_item_684_addname_dataframe[table_name] = stk_rewards_item_684[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_684_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_685_tscode_list = list() 
stk_rewards_item_685 = pro.stk_rewards(ts_code='603986.SH,603987.SH,603988.SH,603989.SH,603990.SH,603991.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_685 返回数据 row 行数 = "+str(stk_rewards_item_685.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_685['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_685_tscode_list.append(stock_name)
stk_rewards_item_685_addname_dataframe=pd.DataFrame()
stk_rewards_item_685_addname_dataframe['cname'] = stk_rewards_item_685_tscode_list
for table_name in stk_rewards_item_685.columns.values.tolist():
    stk_rewards_item_685_addname_dataframe[table_name] = stk_rewards_item_685[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_685_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_686_tscode_list = list() 
stk_rewards_item_686 = pro.stk_rewards(ts_code='603992.SH,603993.SH,603995.SH,603996.SH,603997.SH,603998.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_686 返回数据 row 行数 = "+str(stk_rewards_item_686.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_686['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_686_tscode_list.append(stock_name)
stk_rewards_item_686_addname_dataframe=pd.DataFrame()
stk_rewards_item_686_addname_dataframe['cname'] = stk_rewards_item_686_tscode_list
for table_name in stk_rewards_item_686.columns.values.tolist():
    stk_rewards_item_686_addname_dataframe[table_name] = stk_rewards_item_686[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_686_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_687_tscode_list = list() 
stk_rewards_item_687 = pro.stk_rewards(ts_code='603999.SH,605001.SH,605003.SH,605005.SH,605006.SH,605007.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_687 返回数据 row 行数 = "+str(stk_rewards_item_687.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_687['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_687_tscode_list.append(stock_name)
stk_rewards_item_687_addname_dataframe=pd.DataFrame()
stk_rewards_item_687_addname_dataframe['cname'] = stk_rewards_item_687_tscode_list
for table_name in stk_rewards_item_687.columns.values.tolist():
    stk_rewards_item_687_addname_dataframe[table_name] = stk_rewards_item_687[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_687_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_688_tscode_list = list() 
stk_rewards_item_688 = pro.stk_rewards(ts_code='605008.SH,605009.SH,605011.SH,605016.SH,605018.SH,605050.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_688 返回数据 row 行数 = "+str(stk_rewards_item_688.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_688['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_688_tscode_list.append(stock_name)
stk_rewards_item_688_addname_dataframe=pd.DataFrame()
stk_rewards_item_688_addname_dataframe['cname'] = stk_rewards_item_688_tscode_list
for table_name in stk_rewards_item_688.columns.values.tolist():
    stk_rewards_item_688_addname_dataframe[table_name] = stk_rewards_item_688[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_688_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_689_tscode_list = list() 
stk_rewards_item_689 = pro.stk_rewards(ts_code='605055.SH,605058.SH,605060.SH,605066.SH,605068.SH,605077.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_689 返回数据 row 行数 = "+str(stk_rewards_item_689.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_689['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_689_tscode_list.append(stock_name)
stk_rewards_item_689_addname_dataframe=pd.DataFrame()
stk_rewards_item_689_addname_dataframe['cname'] = stk_rewards_item_689_tscode_list
for table_name in stk_rewards_item_689.columns.values.tolist():
    stk_rewards_item_689_addname_dataframe[table_name] = stk_rewards_item_689[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_689_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_690_tscode_list = list() 
stk_rewards_item_690 = pro.stk_rewards(ts_code='605080.SH,605081.SH,605086.SH,605088.SH,605089.SH,605090.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_690 返回数据 row 行数 = "+str(stk_rewards_item_690.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_690['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_690_tscode_list.append(stock_name)
stk_rewards_item_690_addname_dataframe=pd.DataFrame()
stk_rewards_item_690_addname_dataframe['cname'] = stk_rewards_item_690_tscode_list
for table_name in stk_rewards_item_690.columns.values.tolist():
    stk_rewards_item_690_addname_dataframe[table_name] = stk_rewards_item_690[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_690_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_691_tscode_list = list() 
stk_rewards_item_691 = pro.stk_rewards(ts_code='605098.SH,605099.SH,605100.SH,605108.SH,605111.SH,605116.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_691 返回数据 row 行数 = "+str(stk_rewards_item_691.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_691['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_691_tscode_list.append(stock_name)
stk_rewards_item_691_addname_dataframe=pd.DataFrame()
stk_rewards_item_691_addname_dataframe['cname'] = stk_rewards_item_691_tscode_list
for table_name in stk_rewards_item_691.columns.values.tolist():
    stk_rewards_item_691_addname_dataframe[table_name] = stk_rewards_item_691[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_691_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_692_tscode_list = list() 
stk_rewards_item_692 = pro.stk_rewards(ts_code='605117.SH,605118.SH,605122.SH,605123.SH,605128.SH,605133.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_692 返回数据 row 行数 = "+str(stk_rewards_item_692.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_692['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_692_tscode_list.append(stock_name)
stk_rewards_item_692_addname_dataframe=pd.DataFrame()
stk_rewards_item_692_addname_dataframe['cname'] = stk_rewards_item_692_tscode_list
for table_name in stk_rewards_item_692.columns.values.tolist():
    stk_rewards_item_692_addname_dataframe[table_name] = stk_rewards_item_692[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_692_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_693_tscode_list = list() 
stk_rewards_item_693 = pro.stk_rewards(ts_code='605136.SH,605151.SH,605155.SH,605158.SH,605162.SH,605166.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_693 返回数据 row 行数 = "+str(stk_rewards_item_693.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_693['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_693_tscode_list.append(stock_name)
stk_rewards_item_693_addname_dataframe=pd.DataFrame()
stk_rewards_item_693_addname_dataframe['cname'] = stk_rewards_item_693_tscode_list
for table_name in stk_rewards_item_693.columns.values.tolist():
    stk_rewards_item_693_addname_dataframe[table_name] = stk_rewards_item_693[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_693_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_694_tscode_list = list() 
stk_rewards_item_694 = pro.stk_rewards(ts_code='605168.SH,605169.SH,605177.SH,605178.SH,605179.SH,605180.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_694 返回数据 row 行数 = "+str(stk_rewards_item_694.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_694['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_694_tscode_list.append(stock_name)
stk_rewards_item_694_addname_dataframe=pd.DataFrame()
stk_rewards_item_694_addname_dataframe['cname'] = stk_rewards_item_694_tscode_list
for table_name in stk_rewards_item_694.columns.values.tolist():
    stk_rewards_item_694_addname_dataframe[table_name] = stk_rewards_item_694[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_694_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_695_tscode_list = list() 
stk_rewards_item_695 = pro.stk_rewards(ts_code='605183.SH,605186.SH,605188.SH,605189.SH,605196.SH,605198.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_695 返回数据 row 行数 = "+str(stk_rewards_item_695.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_695['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_695_tscode_list.append(stock_name)
stk_rewards_item_695_addname_dataframe=pd.DataFrame()
stk_rewards_item_695_addname_dataframe['cname'] = stk_rewards_item_695_tscode_list
for table_name in stk_rewards_item_695.columns.values.tolist():
    stk_rewards_item_695_addname_dataframe[table_name] = stk_rewards_item_695[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_695_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_696_tscode_list = list() 
stk_rewards_item_696 = pro.stk_rewards(ts_code='605199.SH,605208.SH,605218.SH,605222.SH,605228.SH,605255.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_696 返回数据 row 行数 = "+str(stk_rewards_item_696.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_696['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_696_tscode_list.append(stock_name)
stk_rewards_item_696_addname_dataframe=pd.DataFrame()
stk_rewards_item_696_addname_dataframe['cname'] = stk_rewards_item_696_tscode_list
for table_name in stk_rewards_item_696.columns.values.tolist():
    stk_rewards_item_696_addname_dataframe[table_name] = stk_rewards_item_696[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_696_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_697_tscode_list = list() 
stk_rewards_item_697 = pro.stk_rewards(ts_code='605258.SH,605259.SH,605266.SH,605268.SH,605277.SH,605286.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_697 返回数据 row 行数 = "+str(stk_rewards_item_697.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_697['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_697_tscode_list.append(stock_name)
stk_rewards_item_697_addname_dataframe=pd.DataFrame()
stk_rewards_item_697_addname_dataframe['cname'] = stk_rewards_item_697_tscode_list
for table_name in stk_rewards_item_697.columns.values.tolist():
    stk_rewards_item_697_addname_dataframe[table_name] = stk_rewards_item_697[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_697_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_698_tscode_list = list() 
stk_rewards_item_698 = pro.stk_rewards(ts_code='605287.SH,605288.SH,605289.SH,605296.SH,605298.SH,605299.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_698 返回数据 row 行数 = "+str(stk_rewards_item_698.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_698['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_698_tscode_list.append(stock_name)
stk_rewards_item_698_addname_dataframe=pd.DataFrame()
stk_rewards_item_698_addname_dataframe['cname'] = stk_rewards_item_698_tscode_list
for table_name in stk_rewards_item_698.columns.values.tolist():
    stk_rewards_item_698_addname_dataframe[table_name] = stk_rewards_item_698[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_698_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_699_tscode_list = list() 
stk_rewards_item_699 = pro.stk_rewards(ts_code='605300.SH,605303.SH,605305.SH,605318.SH,605319.SH,605333.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_699 返回数据 row 行数 = "+str(stk_rewards_item_699.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_699['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_699_tscode_list.append(stock_name)
stk_rewards_item_699_addname_dataframe=pd.DataFrame()
stk_rewards_item_699_addname_dataframe['cname'] = stk_rewards_item_699_tscode_list
for table_name in stk_rewards_item_699.columns.values.tolist():
    stk_rewards_item_699_addname_dataframe[table_name] = stk_rewards_item_699[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_699_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_700_tscode_list = list() 
stk_rewards_item_700 = pro.stk_rewards(ts_code='605336.SH,605337.SH,605338.SH,605339.SH,605358.SH,605366.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_700 返回数据 row 行数 = "+str(stk_rewards_item_700.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_700['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_700_tscode_list.append(stock_name)
stk_rewards_item_700_addname_dataframe=pd.DataFrame()
stk_rewards_item_700_addname_dataframe['cname'] = stk_rewards_item_700_tscode_list
for table_name in stk_rewards_item_700.columns.values.tolist():
    stk_rewards_item_700_addname_dataframe[table_name] = stk_rewards_item_700[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_700_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_701_tscode_list = list() 
stk_rewards_item_701 = pro.stk_rewards(ts_code='605368.SH,605369.SH,605376.SH,605377.SH,605378.SH,605388.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_701 返回数据 row 行数 = "+str(stk_rewards_item_701.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_701['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_701_tscode_list.append(stock_name)
stk_rewards_item_701_addname_dataframe=pd.DataFrame()
stk_rewards_item_701_addname_dataframe['cname'] = stk_rewards_item_701_tscode_list
for table_name in stk_rewards_item_701.columns.values.tolist():
    stk_rewards_item_701_addname_dataframe[table_name] = stk_rewards_item_701[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_701_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_702_tscode_list = list() 
stk_rewards_item_702 = pro.stk_rewards(ts_code='605389.SH,605398.SH,605399.SH,605488.SH,605499.SH,605500.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_702 返回数据 row 行数 = "+str(stk_rewards_item_702.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_702['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_702_tscode_list.append(stock_name)
stk_rewards_item_702_addname_dataframe=pd.DataFrame()
stk_rewards_item_702_addname_dataframe['cname'] = stk_rewards_item_702_tscode_list
for table_name in stk_rewards_item_702.columns.values.tolist():
    stk_rewards_item_702_addname_dataframe[table_name] = stk_rewards_item_702[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_702_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_703_tscode_list = list() 
stk_rewards_item_703 = pro.stk_rewards(ts_code='688001.SH,688002.SH,688003.SH,688004.SH,688005.SH,688006.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_703 返回数据 row 行数 = "+str(stk_rewards_item_703.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_703['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_703_tscode_list.append(stock_name)
stk_rewards_item_703_addname_dataframe=pd.DataFrame()
stk_rewards_item_703_addname_dataframe['cname'] = stk_rewards_item_703_tscode_list
for table_name in stk_rewards_item_703.columns.values.tolist():
    stk_rewards_item_703_addname_dataframe[table_name] = stk_rewards_item_703[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_703_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_704_tscode_list = list() 
stk_rewards_item_704 = pro.stk_rewards(ts_code='688007.SH,688008.SH,688009.SH,688010.SH,688011.SH,688012.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_704 返回数据 row 行数 = "+str(stk_rewards_item_704.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_704['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_704_tscode_list.append(stock_name)
stk_rewards_item_704_addname_dataframe=pd.DataFrame()
stk_rewards_item_704_addname_dataframe['cname'] = stk_rewards_item_704_tscode_list
for table_name in stk_rewards_item_704.columns.values.tolist():
    stk_rewards_item_704_addname_dataframe[table_name] = stk_rewards_item_704[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_704_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_705_tscode_list = list() 
stk_rewards_item_705 = pro.stk_rewards(ts_code='688013.SH,688015.SH,688016.SH,688017.SH,688018.SH,688019.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_705 返回数据 row 行数 = "+str(stk_rewards_item_705.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_705['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_705_tscode_list.append(stock_name)
stk_rewards_item_705_addname_dataframe=pd.DataFrame()
stk_rewards_item_705_addname_dataframe['cname'] = stk_rewards_item_705_tscode_list
for table_name in stk_rewards_item_705.columns.values.tolist():
    stk_rewards_item_705_addname_dataframe[table_name] = stk_rewards_item_705[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_705_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_706_tscode_list = list() 
stk_rewards_item_706 = pro.stk_rewards(ts_code='688020.SH,688021.SH,688022.SH,688023.SH,688025.SH,688026.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_706 返回数据 row 行数 = "+str(stk_rewards_item_706.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_706['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_706_tscode_list.append(stock_name)
stk_rewards_item_706_addname_dataframe=pd.DataFrame()
stk_rewards_item_706_addname_dataframe['cname'] = stk_rewards_item_706_tscode_list
for table_name in stk_rewards_item_706.columns.values.tolist():
    stk_rewards_item_706_addname_dataframe[table_name] = stk_rewards_item_706[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_706_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_707_tscode_list = list() 
stk_rewards_item_707 = pro.stk_rewards(ts_code='688027.SH,688028.SH,688029.SH,688030.SH,688033.SH,688036.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_707 返回数据 row 行数 = "+str(stk_rewards_item_707.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_707['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_707_tscode_list.append(stock_name)
stk_rewards_item_707_addname_dataframe=pd.DataFrame()
stk_rewards_item_707_addname_dataframe['cname'] = stk_rewards_item_707_tscode_list
for table_name in stk_rewards_item_707.columns.values.tolist():
    stk_rewards_item_707_addname_dataframe[table_name] = stk_rewards_item_707[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_707_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_708_tscode_list = list() 
stk_rewards_item_708 = pro.stk_rewards(ts_code='688037.SH,688039.SH,688050.SH,688051.SH,688055.SH,688056.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_708 返回数据 row 行数 = "+str(stk_rewards_item_708.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_708['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_708_tscode_list.append(stock_name)
stk_rewards_item_708_addname_dataframe=pd.DataFrame()
stk_rewards_item_708_addname_dataframe['cname'] = stk_rewards_item_708_tscode_list
for table_name in stk_rewards_item_708.columns.values.tolist():
    stk_rewards_item_708_addname_dataframe[table_name] = stk_rewards_item_708[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_708_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_709_tscode_list = list() 
stk_rewards_item_709 = pro.stk_rewards(ts_code='688057.SH,688058.SH,688059.SH,688060.SH,688063.SH,688065.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_709 返回数据 row 行数 = "+str(stk_rewards_item_709.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_709['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_709_tscode_list.append(stock_name)
stk_rewards_item_709_addname_dataframe=pd.DataFrame()
stk_rewards_item_709_addname_dataframe['cname'] = stk_rewards_item_709_tscode_list
for table_name in stk_rewards_item_709.columns.values.tolist():
    stk_rewards_item_709_addname_dataframe[table_name] = stk_rewards_item_709[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_709_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_710_tscode_list = list() 
stk_rewards_item_710 = pro.stk_rewards(ts_code='688066.SH,688067.SH,688068.SH,688069.SH,688070.SH,688076.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_710 返回数据 row 行数 = "+str(stk_rewards_item_710.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_710['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_710_tscode_list.append(stock_name)
stk_rewards_item_710_addname_dataframe=pd.DataFrame()
stk_rewards_item_710_addname_dataframe['cname'] = stk_rewards_item_710_tscode_list
for table_name in stk_rewards_item_710.columns.values.tolist():
    stk_rewards_item_710_addname_dataframe[table_name] = stk_rewards_item_710[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_710_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_711_tscode_list = list() 
stk_rewards_item_711 = pro.stk_rewards(ts_code='688077.SH,688078.SH,688079.SH,688080.SH,688081.SH,688083.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_711 返回数据 row 行数 = "+str(stk_rewards_item_711.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_711['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_711_tscode_list.append(stock_name)
stk_rewards_item_711_addname_dataframe=pd.DataFrame()
stk_rewards_item_711_addname_dataframe['cname'] = stk_rewards_item_711_tscode_list
for table_name in stk_rewards_item_711.columns.values.tolist():
    stk_rewards_item_711_addname_dataframe[table_name] = stk_rewards_item_711[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_711_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_712_tscode_list = list() 
stk_rewards_item_712 = pro.stk_rewards(ts_code='688085.SH,688086.SH,688088.SH,688089.SH,688090.SH,688092.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_712 返回数据 row 行数 = "+str(stk_rewards_item_712.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_712['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_712_tscode_list.append(stock_name)
stk_rewards_item_712_addname_dataframe=pd.DataFrame()
stk_rewards_item_712_addname_dataframe['cname'] = stk_rewards_item_712_tscode_list
for table_name in stk_rewards_item_712.columns.values.tolist():
    stk_rewards_item_712_addname_dataframe[table_name] = stk_rewards_item_712[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_712_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_713_tscode_list = list() 
stk_rewards_item_713 = pro.stk_rewards(ts_code='688093.SH,688095.SH,688096.SH,688097.SH,688098.SH,688099.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_713 返回数据 row 行数 = "+str(stk_rewards_item_713.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_713['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_713_tscode_list.append(stock_name)
stk_rewards_item_713_addname_dataframe=pd.DataFrame()
stk_rewards_item_713_addname_dataframe['cname'] = stk_rewards_item_713_tscode_list
for table_name in stk_rewards_item_713.columns.values.tolist():
    stk_rewards_item_713_addname_dataframe[table_name] = stk_rewards_item_713[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_713_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_714_tscode_list = list() 
stk_rewards_item_714 = pro.stk_rewards(ts_code='688100.SH,688101.SH,688106.SH,688108.SH,688109.SH,688111.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_714 返回数据 row 行数 = "+str(stk_rewards_item_714.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_714['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_714_tscode_list.append(stock_name)
stk_rewards_item_714_addname_dataframe=pd.DataFrame()
stk_rewards_item_714_addname_dataframe['cname'] = stk_rewards_item_714_tscode_list
for table_name in stk_rewards_item_714.columns.values.tolist():
    stk_rewards_item_714_addname_dataframe[table_name] = stk_rewards_item_714[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_714_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_715_tscode_list = list() 
stk_rewards_item_715 = pro.stk_rewards(ts_code='688113.SH,688116.SH,688117.SH,688118.SH,688122.SH,688123.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_715 返回数据 row 行数 = "+str(stk_rewards_item_715.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_715['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_715_tscode_list.append(stock_name)
stk_rewards_item_715_addname_dataframe=pd.DataFrame()
stk_rewards_item_715_addname_dataframe['cname'] = stk_rewards_item_715_tscode_list
for table_name in stk_rewards_item_715.columns.values.tolist():
    stk_rewards_item_715_addname_dataframe[table_name] = stk_rewards_item_715[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_715_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_716_tscode_list = list() 
stk_rewards_item_716 = pro.stk_rewards(ts_code='688126.SH,688127.SH,688128.SH,688129.SH,688131.SH,688133.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_716 返回数据 row 行数 = "+str(stk_rewards_item_716.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_716['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_716_tscode_list.append(stock_name)
stk_rewards_item_716_addname_dataframe=pd.DataFrame()
stk_rewards_item_716_addname_dataframe['cname'] = stk_rewards_item_716_tscode_list
for table_name in stk_rewards_item_716.columns.values.tolist():
    stk_rewards_item_716_addname_dataframe[table_name] = stk_rewards_item_716[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_716_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_717_tscode_list = list() 
stk_rewards_item_717 = pro.stk_rewards(ts_code='688135.SH,688136.SH,688138.SH,688139.SH,688155.SH,688156.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_717 返回数据 row 行数 = "+str(stk_rewards_item_717.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_717['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_717_tscode_list.append(stock_name)
stk_rewards_item_717_addname_dataframe=pd.DataFrame()
stk_rewards_item_717_addname_dataframe['cname'] = stk_rewards_item_717_tscode_list
for table_name in stk_rewards_item_717.columns.values.tolist():
    stk_rewards_item_717_addname_dataframe[table_name] = stk_rewards_item_717[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_717_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_718_tscode_list = list() 
stk_rewards_item_718 = pro.stk_rewards(ts_code='688157.SH,688158.SH,688159.SH,688160.SH,688161.SH,688165.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_718 返回数据 row 行数 = "+str(stk_rewards_item_718.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_718['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_718_tscode_list.append(stock_name)
stk_rewards_item_718_addname_dataframe=pd.DataFrame()
stk_rewards_item_718_addname_dataframe['cname'] = stk_rewards_item_718_tscode_list
for table_name in stk_rewards_item_718.columns.values.tolist():
    stk_rewards_item_718_addname_dataframe[table_name] = stk_rewards_item_718[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_718_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_719_tscode_list = list() 
stk_rewards_item_719 = pro.stk_rewards(ts_code='688166.SH,688168.SH,688169.SH,688177.SH,688178.SH,688179.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_719 返回数据 row 行数 = "+str(stk_rewards_item_719.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_719['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_719_tscode_list.append(stock_name)
stk_rewards_item_719_addname_dataframe=pd.DataFrame()
stk_rewards_item_719_addname_dataframe['cname'] = stk_rewards_item_719_tscode_list
for table_name in stk_rewards_item_719.columns.values.tolist():
    stk_rewards_item_719_addname_dataframe[table_name] = stk_rewards_item_719[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_719_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_720_tscode_list = list() 
stk_rewards_item_720 = pro.stk_rewards(ts_code='688180.SH,688181.SH,688183.SH,688185.SH,688186.SH,688188.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_720 返回数据 row 行数 = "+str(stk_rewards_item_720.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_720['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_720_tscode_list.append(stock_name)
stk_rewards_item_720_addname_dataframe=pd.DataFrame()
stk_rewards_item_720_addname_dataframe['cname'] = stk_rewards_item_720_tscode_list
for table_name in stk_rewards_item_720.columns.values.tolist():
    stk_rewards_item_720_addname_dataframe[table_name] = stk_rewards_item_720[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_720_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_721_tscode_list = list() 
stk_rewards_item_721 = pro.stk_rewards(ts_code='688189.SH,688191.SH,688195.SH,688196.SH,688198.SH,688199.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_721 返回数据 row 行数 = "+str(stk_rewards_item_721.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_721['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_721_tscode_list.append(stock_name)
stk_rewards_item_721_addname_dataframe=pd.DataFrame()
stk_rewards_item_721_addname_dataframe['cname'] = stk_rewards_item_721_tscode_list
for table_name in stk_rewards_item_721.columns.values.tolist():
    stk_rewards_item_721_addname_dataframe[table_name] = stk_rewards_item_721[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_721_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_722_tscode_list = list() 
stk_rewards_item_722 = pro.stk_rewards(ts_code='688200.SH,688201.SH,688202.SH,688208.SH,688215.SH,688216.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_722 返回数据 row 行数 = "+str(stk_rewards_item_722.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_722['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_722_tscode_list.append(stock_name)
stk_rewards_item_722_addname_dataframe=pd.DataFrame()
stk_rewards_item_722_addname_dataframe['cname'] = stk_rewards_item_722_tscode_list
for table_name in stk_rewards_item_722.columns.values.tolist():
    stk_rewards_item_722_addname_dataframe[table_name] = stk_rewards_item_722[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_722_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_723_tscode_list = list() 
stk_rewards_item_723 = pro.stk_rewards(ts_code='688217.SH,688218.SH,688219.SH,688221.SH,688222.SH,688226.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_723 返回数据 row 行数 = "+str(stk_rewards_item_723.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_723['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_723_tscode_list.append(stock_name)
stk_rewards_item_723_addname_dataframe=pd.DataFrame()
stk_rewards_item_723_addname_dataframe['cname'] = stk_rewards_item_723_tscode_list
for table_name in stk_rewards_item_723.columns.values.tolist():
    stk_rewards_item_723_addname_dataframe[table_name] = stk_rewards_item_723[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_723_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_724_tscode_list = list() 
stk_rewards_item_724 = pro.stk_rewards(ts_code='688228.SH,688229.SH,688233.SH,688239.SH,688256.SH,688258.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_724 返回数据 row 行数 = "+str(stk_rewards_item_724.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_724['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_724_tscode_list.append(stock_name)
stk_rewards_item_724_addname_dataframe=pd.DataFrame()
stk_rewards_item_724_addname_dataframe['cname'] = stk_rewards_item_724_tscode_list
for table_name in stk_rewards_item_724.columns.values.tolist():
    stk_rewards_item_724_addname_dataframe[table_name] = stk_rewards_item_724[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_724_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_725_tscode_list = list() 
stk_rewards_item_725 = pro.stk_rewards(ts_code='688260.SH,688266.SH,688268.SH,688269.SH,688276.SH,688277.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_725 返回数据 row 行数 = "+str(stk_rewards_item_725.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_725['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_725_tscode_list.append(stock_name)
stk_rewards_item_725_addname_dataframe=pd.DataFrame()
stk_rewards_item_725_addname_dataframe['cname'] = stk_rewards_item_725_tscode_list
for table_name in stk_rewards_item_725.columns.values.tolist():
    stk_rewards_item_725_addname_dataframe[table_name] = stk_rewards_item_725[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_725_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_726_tscode_list = list() 
stk_rewards_item_726 = pro.stk_rewards(ts_code='688278.SH,688286.SH,688288.SH,688289.SH,688298.SH,688299.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_726 返回数据 row 行数 = "+str(stk_rewards_item_726.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_726['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_726_tscode_list.append(stock_name)
stk_rewards_item_726_addname_dataframe=pd.DataFrame()
stk_rewards_item_726_addname_dataframe['cname'] = stk_rewards_item_726_tscode_list
for table_name in stk_rewards_item_726.columns.values.tolist():
    stk_rewards_item_726_addname_dataframe[table_name] = stk_rewards_item_726[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_726_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_727_tscode_list = list() 
stk_rewards_item_727 = pro.stk_rewards(ts_code='688300.SH,688301.SH,688308.SH,688309.SH,688310.SH,688311.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_727 返回数据 row 行数 = "+str(stk_rewards_item_727.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_727['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_727_tscode_list.append(stock_name)
stk_rewards_item_727_addname_dataframe=pd.DataFrame()
stk_rewards_item_727_addname_dataframe['cname'] = stk_rewards_item_727_tscode_list
for table_name in stk_rewards_item_727.columns.values.tolist():
    stk_rewards_item_727_addname_dataframe[table_name] = stk_rewards_item_727[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_727_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_728_tscode_list = list() 
stk_rewards_item_728 = pro.stk_rewards(ts_code='688312.SH,688313.SH,688314.SH,688315.SH,688316.SH,688317.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_728 返回数据 row 行数 = "+str(stk_rewards_item_728.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_728['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_728_tscode_list.append(stock_name)
stk_rewards_item_728_addname_dataframe=pd.DataFrame()
stk_rewards_item_728_addname_dataframe['cname'] = stk_rewards_item_728_tscode_list
for table_name in stk_rewards_item_728.columns.values.tolist():
    stk_rewards_item_728_addname_dataframe[table_name] = stk_rewards_item_728[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_728_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_729_tscode_list = list() 
stk_rewards_item_729 = pro.stk_rewards(ts_code='688318.SH,688319.SH,688321.SH,688323.SH,688328.SH,688329.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_729 返回数据 row 行数 = "+str(stk_rewards_item_729.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_729['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_729_tscode_list.append(stock_name)
stk_rewards_item_729_addname_dataframe=pd.DataFrame()
stk_rewards_item_729_addname_dataframe['cname'] = stk_rewards_item_729_tscode_list
for table_name in stk_rewards_item_729.columns.values.tolist():
    stk_rewards_item_729_addname_dataframe[table_name] = stk_rewards_item_729[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_729_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_730_tscode_list = list() 
stk_rewards_item_730 = pro.stk_rewards(ts_code='688330.SH,688333.SH,688335.SH,688336.SH,688338.SH,688339.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_730 返回数据 row 行数 = "+str(stk_rewards_item_730.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_730['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_730_tscode_list.append(stock_name)
stk_rewards_item_730_addname_dataframe=pd.DataFrame()
stk_rewards_item_730_addname_dataframe['cname'] = stk_rewards_item_730_tscode_list
for table_name in stk_rewards_item_730.columns.values.tolist():
    stk_rewards_item_730_addname_dataframe[table_name] = stk_rewards_item_730[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_730_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_731_tscode_list = list() 
stk_rewards_item_731 = pro.stk_rewards(ts_code='688345.SH,688350.SH,688355.SH,688356.SH,688357.SH,688358.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_731 返回数据 row 行数 = "+str(stk_rewards_item_731.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_731['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_731_tscode_list.append(stock_name)
stk_rewards_item_731_addname_dataframe=pd.DataFrame()
stk_rewards_item_731_addname_dataframe['cname'] = stk_rewards_item_731_tscode_list
for table_name in stk_rewards_item_731.columns.values.tolist():
    stk_rewards_item_731_addname_dataframe[table_name] = stk_rewards_item_731[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_731_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_732_tscode_list = list() 
stk_rewards_item_732 = pro.stk_rewards(ts_code='688359.SH,688360.SH,688363.SH,688365.SH,688366.SH,688367.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_732 返回数据 row 行数 = "+str(stk_rewards_item_732.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_732['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_732_tscode_list.append(stock_name)
stk_rewards_item_732_addname_dataframe=pd.DataFrame()
stk_rewards_item_732_addname_dataframe['cname'] = stk_rewards_item_732_tscode_list
for table_name in stk_rewards_item_732.columns.values.tolist():
    stk_rewards_item_732_addname_dataframe[table_name] = stk_rewards_item_732[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_732_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_733_tscode_list = list() 
stk_rewards_item_733 = pro.stk_rewards(ts_code='688368.SH,688369.SH,688377.SH,688378.SH,688379.SH,688383.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_733 返回数据 row 行数 = "+str(stk_rewards_item_733.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_733['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_733_tscode_list.append(stock_name)
stk_rewards_item_733_addname_dataframe=pd.DataFrame()
stk_rewards_item_733_addname_dataframe['cname'] = stk_rewards_item_733_tscode_list
for table_name in stk_rewards_item_733.columns.values.tolist():
    stk_rewards_item_733_addname_dataframe[table_name] = stk_rewards_item_733[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_733_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_734_tscode_list = list() 
stk_rewards_item_734 = pro.stk_rewards(ts_code='688386.SH,688388.SH,688389.SH,688390.SH,688393.SH,688395.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_734 返回数据 row 行数 = "+str(stk_rewards_item_734.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_734['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_734_tscode_list.append(stock_name)
stk_rewards_item_734_addname_dataframe=pd.DataFrame()
stk_rewards_item_734_addname_dataframe['cname'] = stk_rewards_item_734_tscode_list
for table_name in stk_rewards_item_734.columns.values.tolist():
    stk_rewards_item_734_addname_dataframe[table_name] = stk_rewards_item_734[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_734_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_735_tscode_list = list() 
stk_rewards_item_735 = pro.stk_rewards(ts_code='688396.SH,688398.SH,688399.SH,688408.SH,688418.SH,688425.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_735 返回数据 row 行数 = "+str(stk_rewards_item_735.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_735['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_735_tscode_list.append(stock_name)
stk_rewards_item_735_addname_dataframe=pd.DataFrame()
stk_rewards_item_735_addname_dataframe['cname'] = stk_rewards_item_735_tscode_list
for table_name in stk_rewards_item_735.columns.values.tolist():
    stk_rewards_item_735_addname_dataframe[table_name] = stk_rewards_item_735[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_735_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_736_tscode_list = list() 
stk_rewards_item_736 = pro.stk_rewards(ts_code='688456.SH,688466.SH,688468.SH,688488.SH,688499.SH,688500.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_736 返回数据 row 行数 = "+str(stk_rewards_item_736.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_736['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_736_tscode_list.append(stock_name)
stk_rewards_item_736_addname_dataframe=pd.DataFrame()
stk_rewards_item_736_addname_dataframe['cname'] = stk_rewards_item_736_tscode_list
for table_name in stk_rewards_item_736.columns.values.tolist():
    stk_rewards_item_736_addname_dataframe[table_name] = stk_rewards_item_736[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_736_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_737_tscode_list = list() 
stk_rewards_item_737 = pro.stk_rewards(ts_code='688505.SH,688508.SH,688510.SH,688513.SH,688516.SH,688517.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_737 返回数据 row 行数 = "+str(stk_rewards_item_737.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_737['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_737_tscode_list.append(stock_name)
stk_rewards_item_737_addname_dataframe=pd.DataFrame()
stk_rewards_item_737_addname_dataframe['cname'] = stk_rewards_item_737_tscode_list
for table_name in stk_rewards_item_737.columns.values.tolist():
    stk_rewards_item_737_addname_dataframe[table_name] = stk_rewards_item_737[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_737_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_738_tscode_list = list() 
stk_rewards_item_738 = pro.stk_rewards(ts_code='688518.SH,688519.SH,688520.SH,688521.SH,688526.SH,688528.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_738 返回数据 row 行数 = "+str(stk_rewards_item_738.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_738['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_738_tscode_list.append(stock_name)
stk_rewards_item_738_addname_dataframe=pd.DataFrame()
stk_rewards_item_738_addname_dataframe['cname'] = stk_rewards_item_738_tscode_list
for table_name in stk_rewards_item_738.columns.values.tolist():
    stk_rewards_item_738_addname_dataframe[table_name] = stk_rewards_item_738[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_738_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_739_tscode_list = list() 
stk_rewards_item_739 = pro.stk_rewards(ts_code='688529.SH,688533.SH,688536.SH,688538.SH,688550.SH,688551.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_739 返回数据 row 行数 = "+str(stk_rewards_item_739.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_739['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_739_tscode_list.append(stock_name)
stk_rewards_item_739_addname_dataframe=pd.DataFrame()
stk_rewards_item_739_addname_dataframe['cname'] = stk_rewards_item_739_tscode_list
for table_name in stk_rewards_item_739.columns.values.tolist():
    stk_rewards_item_739_addname_dataframe[table_name] = stk_rewards_item_739[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_739_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_740_tscode_list = list() 
stk_rewards_item_740 = pro.stk_rewards(ts_code='688555.SH,688556.SH,688557.SH,688558.SH,688559.SH,688560.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_740 返回数据 row 行数 = "+str(stk_rewards_item_740.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_740['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_740_tscode_list.append(stock_name)
stk_rewards_item_740_addname_dataframe=pd.DataFrame()
stk_rewards_item_740_addname_dataframe['cname'] = stk_rewards_item_740_tscode_list
for table_name in stk_rewards_item_740.columns.values.tolist():
    stk_rewards_item_740_addname_dataframe[table_name] = stk_rewards_item_740[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_740_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_741_tscode_list = list() 
stk_rewards_item_741 = pro.stk_rewards(ts_code='688561.SH,688565.SH,688566.SH,688567.SH,688568.SH,688569.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_741 返回数据 row 行数 = "+str(stk_rewards_item_741.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_741['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_741_tscode_list.append(stock_name)
stk_rewards_item_741_addname_dataframe=pd.DataFrame()
stk_rewards_item_741_addname_dataframe['cname'] = stk_rewards_item_741_tscode_list
for table_name in stk_rewards_item_741.columns.values.tolist():
    stk_rewards_item_741_addname_dataframe[table_name] = stk_rewards_item_741[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_741_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_742_tscode_list = list() 
stk_rewards_item_742 = pro.stk_rewards(ts_code='688571.SH,688575.SH,688577.SH,688578.SH,688579.SH,688580.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_742 返回数据 row 行数 = "+str(stk_rewards_item_742.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_742['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_742_tscode_list.append(stock_name)
stk_rewards_item_742_addname_dataframe=pd.DataFrame()
stk_rewards_item_742_addname_dataframe['cname'] = stk_rewards_item_742_tscode_list
for table_name in stk_rewards_item_742.columns.values.tolist():
    stk_rewards_item_742_addname_dataframe[table_name] = stk_rewards_item_742[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_742_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_743_tscode_list = list() 
stk_rewards_item_743 = pro.stk_rewards(ts_code='688585.SH,688586.SH,688588.SH,688589.SH,688590.SH,688595.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_743 返回数据 row 行数 = "+str(stk_rewards_item_743.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_743['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_743_tscode_list.append(stock_name)
stk_rewards_item_743_addname_dataframe=pd.DataFrame()
stk_rewards_item_743_addname_dataframe['cname'] = stk_rewards_item_743_tscode_list
for table_name in stk_rewards_item_743.columns.values.tolist():
    stk_rewards_item_743_addname_dataframe[table_name] = stk_rewards_item_743[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_743_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_744_tscode_list = list() 
stk_rewards_item_744 = pro.stk_rewards(ts_code='688596.SH,688597.SH,688598.SH,688599.SH,688600.SH,688601.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_744 返回数据 row 行数 = "+str(stk_rewards_item_744.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_744['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_744_tscode_list.append(stock_name)
stk_rewards_item_744_addname_dataframe=pd.DataFrame()
stk_rewards_item_744_addname_dataframe['cname'] = stk_rewards_item_744_tscode_list
for table_name in stk_rewards_item_744.columns.values.tolist():
    stk_rewards_item_744_addname_dataframe[table_name] = stk_rewards_item_744[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_744_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_745_tscode_list = list() 
stk_rewards_item_745 = pro.stk_rewards(ts_code='688606.SH,688607.SH,688608.SH,688609.SH,688611.SH,688613.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_745 返回数据 row 行数 = "+str(stk_rewards_item_745.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_745['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_745_tscode_list.append(stock_name)
stk_rewards_item_745_addname_dataframe=pd.DataFrame()
stk_rewards_item_745_addname_dataframe['cname'] = stk_rewards_item_745_tscode_list
for table_name in stk_rewards_item_745.columns.values.tolist():
    stk_rewards_item_745_addname_dataframe[table_name] = stk_rewards_item_745[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_745_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_746_tscode_list = list() 
stk_rewards_item_746 = pro.stk_rewards(ts_code='688616.SH,688617.SH,688618.SH,688619.SH,688621.SH,688625.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_746 返回数据 row 行数 = "+str(stk_rewards_item_746.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_746['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_746_tscode_list.append(stock_name)
stk_rewards_item_746_addname_dataframe=pd.DataFrame()
stk_rewards_item_746_addname_dataframe['cname'] = stk_rewards_item_746_tscode_list
for table_name in stk_rewards_item_746.columns.values.tolist():
    stk_rewards_item_746_addname_dataframe[table_name] = stk_rewards_item_746[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_746_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_747_tscode_list = list() 
stk_rewards_item_747 = pro.stk_rewards(ts_code='688626.SH,688628.SH,688630.SH,688633.SH,688636.SH,688639.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_747 返回数据 row 行数 = "+str(stk_rewards_item_747.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_747['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_747_tscode_list.append(stock_name)
stk_rewards_item_747_addname_dataframe=pd.DataFrame()
stk_rewards_item_747_addname_dataframe['cname'] = stk_rewards_item_747_tscode_list
for table_name in stk_rewards_item_747.columns.values.tolist():
    stk_rewards_item_747_addname_dataframe[table_name] = stk_rewards_item_747[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_747_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_748_tscode_list = list() 
stk_rewards_item_748 = pro.stk_rewards(ts_code='688655.SH,688656.SH,688658.SH,688659.SH,688660.SH,688661.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_748 返回数据 row 行数 = "+str(stk_rewards_item_748.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_748['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_748_tscode_list.append(stock_name)
stk_rewards_item_748_addname_dataframe=pd.DataFrame()
stk_rewards_item_748_addname_dataframe['cname'] = stk_rewards_item_748_tscode_list
for table_name in stk_rewards_item_748.columns.values.tolist():
    stk_rewards_item_748_addname_dataframe[table_name] = stk_rewards_item_748[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_748_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_749_tscode_list = list() 
stk_rewards_item_749 = pro.stk_rewards(ts_code='688662.SH,688663.SH,688665.SH,688667.SH,688668.SH,688669.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_749 返回数据 row 行数 = "+str(stk_rewards_item_749.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_749['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_749_tscode_list.append(stock_name)
stk_rewards_item_749_addname_dataframe=pd.DataFrame()
stk_rewards_item_749_addname_dataframe['cname'] = stk_rewards_item_749_tscode_list
for table_name in stk_rewards_item_749.columns.values.tolist():
    stk_rewards_item_749_addname_dataframe[table_name] = stk_rewards_item_749[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_749_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_750_tscode_list = list() 
stk_rewards_item_750 = pro.stk_rewards(ts_code='688676.SH,688677.SH,688678.SH,688679.SH,688680.SH,688681.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_750 返回数据 row 行数 = "+str(stk_rewards_item_750.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_750['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_750_tscode_list.append(stock_name)
stk_rewards_item_750_addname_dataframe=pd.DataFrame()
stk_rewards_item_750_addname_dataframe['cname'] = stk_rewards_item_750_tscode_list
for table_name in stk_rewards_item_750.columns.values.tolist():
    stk_rewards_item_750_addname_dataframe[table_name] = stk_rewards_item_750[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_750_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_751_tscode_list = list() 
stk_rewards_item_751 = pro.stk_rewards(ts_code='688682.SH,688683.SH,688685.SH,688686.SH,688687.SH,688689.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_751 返回数据 row 行数 = "+str(stk_rewards_item_751.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_751['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_751_tscode_list.append(stock_name)
stk_rewards_item_751_addname_dataframe=pd.DataFrame()
stk_rewards_item_751_addname_dataframe['cname'] = stk_rewards_item_751_tscode_list
for table_name in stk_rewards_item_751.columns.values.tolist():
    stk_rewards_item_751_addname_dataframe[table_name] = stk_rewards_item_751[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_751_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_752_tscode_list = list() 
stk_rewards_item_752 = pro.stk_rewards(ts_code='688690.SH,688696.SH,688698.SH,688699.SH,688700.SH,688777.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_752 返回数据 row 行数 = "+str(stk_rewards_item_752.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_752['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_752_tscode_list.append(stock_name)
stk_rewards_item_752_addname_dataframe=pd.DataFrame()
stk_rewards_item_752_addname_dataframe['cname'] = stk_rewards_item_752_tscode_list
for table_name in stk_rewards_item_752.columns.values.tolist():
    stk_rewards_item_752_addname_dataframe[table_name] = stk_rewards_item_752[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_752_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
stk_rewards_item_753_tscode_list = list() 
stk_rewards_item_753 = pro.stk_rewards(ts_code='688788.SH,688819.SH,688981.SH,T00018.SH', fields='ts_code,ann_date,end_date,name,title,reward,hold_vol')
print("管理层薪酬和持股   stk_rewards_item_753 返回数据 row 行数 = "+str(stk_rewards_item_753.shape[0])+"  all_size="+str(stk_rewards_data_List.__len__()))
for ts_code_sh in stk_rewards_item_753['ts_code']:
    stock_name = tscode_name_dict.get(ts_code_sh)
    if stock_name is None:
        stock_name = 'null'
    stk_rewards_item_753_tscode_list.append(stock_name)
stk_rewards_item_753_addname_dataframe=pd.DataFrame()
stk_rewards_item_753_addname_dataframe['cname'] = stk_rewards_item_753_tscode_list
for table_name in stk_rewards_item_753.columns.values.tolist():
    stk_rewards_item_753_addname_dataframe[table_name] = stk_rewards_item_753[table_name]
stk_rewards_data_List = stk_rewards_data_List.append(stk_rewards_item_753_addname_dataframe)
if stk_rewards_data_List.__len__() > 1000000:
    print("stk_rewards_data_List.__len__() = " + str(stk_rewards_data_List.__len__()))
    stk_rewards_data_List.to_excel(stk_rewards_excel_writer, '管理层薪酬和持股_first',index=False)
    stk_rewards_excel_writer.save()
...
print("管理层薪酬和持股  stk_rewards_data_List.__len__() = "+str(stk_rewards_data_List.__len__()))
