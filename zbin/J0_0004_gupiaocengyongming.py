...
namechange_book = load_workbook('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\股票曾用名.xlsx')
namechange_excel_writer = pd.ExcelWriter('C:\\Users\\zhuzj5\\Desktop\\zbin\\J0_Data\\股票曾用名.xlsx', engine='openpyxl')
...
print(" 股票曾用名 namechange_item_0 返回数据 row 行数 = "+str(namechange_item_0.shape[0]))
